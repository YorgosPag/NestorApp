// ⚠️ GENERATED — DO NOT EDIT. Verbatim projection of src/lib/idempotency/event-claim.ts (ADR-874 · CHECK 3.93).
// Edit the source, then run: npm run generate:functions-projection
// sha256:d1b1be4a2457f2dee7a4db33d9d6c8ca6f09f1f9bbaa265f58c7dced6440dcdf
