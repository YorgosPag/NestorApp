...
content = """# 📊 ΑΝΑΦΟΡΑ ΔΙΠΛΟΤΥΠΩΝ: Refs Management (useRef Patterns)
...
with codecs.open('src/md_files/diplotypa/Refs_management.md', 'w', 'utf-8') as f:
    f.write(content)

print('SUCCESS: Refs_management.md created!')
