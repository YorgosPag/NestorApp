...
- **Registry**: `.ssot-registry.json` — 36 modules σε 5 tiers (core, data integrity, security, business logic, enum constants + infrastructure)
- **Baseline**: `.ssot-violations-baseline.json` — 50 αρχεία, 60 violations (2026-04-09)
