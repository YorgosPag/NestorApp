...
| **ADR-365** | Tailwind Semantic Palette Enforcement | 🟢 **PHASE 5 DONE** 2026-05-22 — Shared Files + File Manager migrated (9 files, −73 violations). Baseline: **2,667/362** (was 2,740/371). Awaits Phase 6 (Dashboard + Admin + CRM). | 2026-05-19 | Design System — Theming & Color Tokens | [📄](./adrs/ADR-365-tailwind-semantic-palette-enforcement.md) |
