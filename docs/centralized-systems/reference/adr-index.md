...
| **ADR-479** | Structural Project Presets (Revit-grade templates — `greek-rc-ec8`/`greek-rc-legacy`/`blank` presets αρχικοποιούν building settings από canonical defaults + πραγματική μελέτη Θέρμη 288/08· machine SSoT `THERMI_288_08`· `applyStructuralPreset`· cross-check test engine↔μελέτη) | 🟢 Slice 1 DONE (UNCOMMITTED· 33 jest· DEFER UI+persisted) | [View](./adrs/ADR-479-structural-project-presets.md) |
