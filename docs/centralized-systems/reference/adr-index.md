...
| **ADR-456** | Στατικά: Ποσότητες Σκυροδέματος & Οπλισμός (Slice 1 — ορθογωνική κολώνα)· νέο SSoT `bim/structural/` [concrete-grades + rebar-catalog B500C + code providers Eurocode/ΕΚΩΣ-ΕΑΚ επιλέξιμοι ανά έργο + reinforcement compute]· +`concreteGrade`/`reinforcement` στο ColumnParams· βάρος σκυροδέματος (×2400) + διαμήκης/συνδετήρες/βάρος χάλυβα + ρ_min/ρ_max validation· 5 νέες στήλες schedule· geometry-is-SSoT (παράγωγα re-derived) | 🟢 Slice 1 Implemented — 20+30 jest — pending browser-verify + commit | [View](./adrs/ADR-456-structural-quantities-reinforcement.md) |
