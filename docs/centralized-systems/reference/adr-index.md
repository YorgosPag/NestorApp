...
| **ADR-287** | Enum SSoT Centralization (Batch 9) — CommercialStatus, OperationalStatus, EnergyClass, BuildingType | 🚧 IN PROGRESS (9A-12A done) | 2026-04-05 | Data & State | [📄](./adrs/ADR-287-enum-ssot-centralization.md) |
