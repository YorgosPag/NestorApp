...
| **ADR-366** | 3D BIM Viewer & Photorealistic Rendering | ✅ 🟢 **PHASES 0-8.1 FULLY IMPLEMENTED** 2026-05-21 + 🔵 **GROUP C RESEARCH CLOSED 7/7** 2026-05-22 + 🟡 **PHASE 9 IN PROGRESS** (C.4 ✅ 2026-05-22, C.5 ✅ 2026-05-22, C.3 ✅ 2026-05-22, C.6 ✅ 2026-05-22, C.2 ✅ 2026-05-24, **C.7 partial: Q1+Q5+Q4 ✅ 2026-05-24 Sessions 1/2/3a**) — **C.7 Q4 ✅ Session 3a 2026-05-24** (auto-submit-fps-threshold FSM + auto-submit-store Zustand+LS + AutoSubmitConsentDialog Greek 3-button + Collector hook + Quality3DPanelTab opt-out toggle + i18n 9×2 + Boy Scout `/api/performance-diagnostics` server route με EntityAuditService ADR-195 audit + snapshot-service client→server migration + firestore.rules performance_diagnostics block + audit-trail.ts +3 auto_submit actions). Pending: C.7 Q3 (telemetry Session 3b) + Q2 (admin dashboard Session 4), C.1 (Animation). Phase 9 remaining effort: ~21-29h. ADR-366 total estimate: ~254-303h Phases 0-9. | 2026-05-19 | DXF Viewer — 3D Rendering / Photorealistic Output | [📄](./adrs/ADR-366-3d-bim-viewer-photorealistic-rendering.md) |
