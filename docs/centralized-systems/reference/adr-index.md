...
| **ADR-366** | 3D BIM Viewer & Photorealistic Rendering | 🔵 **PHASE 9 IN PROGRESS** 2026-05-22 — C.4 ✅ (Materials/BOQ/Comments tabs) + C.5 ✅ (ARIA integration: proxy renderer, keyboard navigator, reduced-motion guards, Accessibility3DPanelTab, skip link). Remaining: C.3→C.6→C.2→C.7→C.1 (~57-70h). | 2026-05-19 | DXF Viewer — 3D Rendering / Photorealistic Output | [📄](./adrs/ADR-366-3d-bim-viewer-photorealistic-rendering.md) |
