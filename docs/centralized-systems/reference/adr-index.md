...
| **ADR-363** | BIM Drawing Mode (Parametric Building Elements) | ✅ 🟢 **APPROVED** 2026-05-17 — All Q1-Q8 answered. Ready for Phase 0 implementation. | 2026-05-17 | DXF Viewer — BIM / Parametric Building Modeling | [📄](./adrs/ADR-363-bim-drawing-mode.md) |
...
| **ADR-365** | Tailwind Semantic Palette Enforcement | 🟢 **PHASE 6 DONE** 2026-05-22 — Dashboard + Admin + CRM + Header + Notifications (11 files, −137 violations). Baseline: **2,530/354** (was 2,667/362). Awaits Phase 7 (Design System + Sales). | 2026-05-19 | Design System — Theming & Color Tokens | [📄](./adrs/ADR-365-tailwind-semantic-palette-enforcement.md) |
| **ADR-366** | 3D BIM Viewer & Photorealistic Rendering | 🔵 **PHASE 9 IN PROGRESS** 2026-05-22 — C.3 ✅ (3D Manual Dimensions Tool: 13 modules + 3 tests + Firestore rules/indexes/permissions/audit infra) + C.4 ✅ (Materials/BOQ/Comments tabs) + C.5 ✅ (ARIA integration). Remaining: C.6→C.2→C.7→C.1 (~47-58h). | 2026-05-19 | DXF Viewer — 3D Rendering / Photorealistic Output | [📄](./adrs/ADR-366-3d-bim-viewer-photorealistic-rendering.md) |
