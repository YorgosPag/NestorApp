...
| **ADR-365** | Tailwind Semantic Palette Enforcement | 🟢 **PHASE 4 DONE** 2026-05-22 — Properties + Contacts + Building Dialogs migrated (23 files, −149 violations). Baseline: **2,740/371** (was 2,889/394). Awaits Phase 5 (Shared Files + File Manager). | 2026-05-19 | Design System — Theming & Color Tokens | [📄](./adrs/ADR-365-tailwind-semantic-palette-enforcement.md) |
