...
| **ADR-612** | Free-standing / self-hosted opening (host-less parametric κούφωμα· `OpeningHost` dual-provider SSoT· optional `wallId` + `selfHost`· placement πάνω σε ADR-600) | 🔵 RECOGNITION+DESIGN | 2026-07-09 | DXF Viewer — BIM / Parametric Building Modeling | [📄](./adrs/ADR-612-free-standing-self-hosted-opening.md) |
