...
| **ADR-394** | Fit to View to Selected Entities (Z key) | ✅ 🟢 **IMPLEMENTED** 2026-05-28 — `Z` = fit-to-selection (DXF + BIM + mixed). Home unchanged (fit-all). SSoT `calculateCombinedEntityBounds`. Command-line precedence + empty-selection fallthrough. Pending commit. | 2026-05-28 | Canvas & Rendering / DXF Viewer — Tools & Keyboard | [📄](./adrs/ADR-394-fit-to-view-selected-entities.md) |
