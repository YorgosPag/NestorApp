...
| **ADR-401** | BIM Wall Top/Base Constraints + Attach-to-Structural (συσχετιστικό αυτόματο ύψος) | 🟢 ACCEPTED — Phase A+B1+B2 DONE | [View](./adrs/ADR-401-bim-wall-top-base-constraints-attach-to-structural.md) |
