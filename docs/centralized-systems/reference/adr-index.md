...
| **ADR-303** | Project Addresses Tab Mutation Impact Guard — per-operation guard (add/edit/delete/set-primary) | 📋 DRAFT | 2026-04-14 | Data Architecture / UX Safety | [📄](../../../adrs/ADR-303-project-addresses-mutation-impact.md) |
