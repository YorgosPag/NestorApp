...
| 📄 **Uncategorized** | 133 | [View](#uncategorized) |
...
| **ADR-395** | BIM Quantities → Building Measurements (Επιμετρήσεις) | 🟢 **PHASE 1 IMPLEMENTED** 2026-05-29 (pending commit) — G3 (buildingId resolution από floorId μέσω useFloorMetadata) + G7 (per-floor: linkedFloorId+scope='floor' stamping + floor-first Measurements accordion) DONE. Κλείνει το «κενή καρτέλα» bug. Phase 2 (G1 σκάλες, 3 γραμμές) εκκρεμεί. | 2026-05-29 | BIM / Quantity Take-Off ↔ Buildings | [📄](./adrs/ADR-395-bim-quantities-building-measurements.md) |
