...
| **ADR-376** | Opening Tags (Ταμπελάκια Ανοιγμάτων) — Revit-Faithful Pattern | ✅ **COMPLETE v12** 2026-05-26 — All phases SHIPPED (A+B.1+B.2+C.1+C.2+C.3). v12 follow-up: inline ribbon tag style panel, i18n JSON fix (flat dot-keys → nested bgColorOptions/leaderColorOptions), tag visibility fix (screen-space offset), auto-contrast text (WCAG), tag clickability. | 2026-05-25 | DXF Viewer — BIM / Annotation | [📄](./adrs/ADR-376-opening-tags.md) |
