...
| **ADR-365** | Tailwind Semantic Palette Enforcement | 🟢 **PHASE 1 DONE** 2026-05-22 — DXF Viewer subapp migrated (20 files). Baseline: **3,405/420** (was 3,659/440, −254 violations). Awaits Phase 2 (Procurement + Vendor Portal). | 2026-05-19 | Design System — Theming & Color Tokens | [📄](./adrs/ADR-365-tailwind-semantic-palette-enforcement.md) |
