...
| **ADR-366** | 3D BIM Viewer & Photorealistic Rendering | ✅ 🟢 **PHASES 0-8.1 FULLY IMPLEMENTED** 2026-05-21 + 🔵 **GROUP C RESEARCH CLOSED 7/7** 2026-05-22 + 🟡 **PHASE 9 IN PROGRESS** (C.4 ✅ 2026-05-22, C.5 ✅ 2026-05-22, C.3 ✅ 2026-05-22, C.6 ✅ 2026-05-22, C.2 ✅ 2026-05-24) — **C.2 ✅ DONE 2026-05-24** (bim-comment-types + comment-status-fsm + comment-anchor-resolver + bim-comments.service + BimCommentsStore + CommentBadgeIcon + comment-marker-textures + CommentMarker3DRenderer + CommentMentionsPicker + CommentAttachmentUploader + CommentAttachmentLightbox + CommentReplyInput + BimCommentDetailsPanel + CommentListPanel + Floating3DPanel wired + BimCommentsTab wired + enterprise-id cmt_bim_*/cmtr_bim_* + Firestore collection+subcollection rules + 6 RBAC perms + 5 notification keys + i18n ~38 keys × 2). Pending: C.7 (Perf HUD ext), C.1 (Animation). Phase 9 remaining effort: ~24-32h. ADR-366 total estimate: ~254-303h Phases 0-9. | 2026-05-19 | DXF Viewer — 3D Rendering / Photorealistic Output | [📄](./adrs/ADR-366-3d-bim-viewer-photorealistic-rendering.md) |
