...
| **ADR-298** | Firestore Rules Test Coverage SSoT + CHECK 3.16 + CI (Phase D) | ✅ IMPLEMENTED (Phase A + hotfix + Phase D) | 2026-04-11 | Security / Testing Infrastructure / SSoT Enforcement | [📄](../../../adrs/ADR-298-firestore-rules-test-coverage-ssot.md) |
