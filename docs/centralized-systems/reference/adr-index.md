...
| **ADR-365** | Tailwind Semantic Palette Enforcement | 🟢 **PHASE 3 DONE** 2026-05-22 — Accounting subapp migrated (19 files, −143 violations). Baseline: **2,889/394** (was 3,032/399). Awaits Phase 4 (Properties + Contacts). | 2026-05-19 | Design System — Theming & Color Tokens | [📄](./adrs/ADR-365-tailwind-semantic-palette-enforcement.md) |
