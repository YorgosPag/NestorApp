...
| **ADR-483** | Static Analysis Canvas Diagrams (T3-UI / Slice 4+4b+ — διαγράμματα M/V/N κατά μήκος δοκαριών στον καμβά· read-only ADR-040 micro-leaf overlay· pure geometry+draw· auto-fit zoom-stable· **4b** selector M/V/N + ζώνες T/C + βέλη φορτίου UDL + caution· **4b+** end values M_i/M_j + σύμβολα στηρίξεων + caption συνδυασμού + σημεία M=0· transient toggle default OFF· κολόνες/3Δ DEFER) | 🟢 DONE (UNCOMMITTED· Slice 4+4b+· 13 jest GREEN) | [View](./adrs/ADR-483-static-analysis-canvas-diagrams.md) |
