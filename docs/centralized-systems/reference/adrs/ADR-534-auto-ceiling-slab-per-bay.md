...
| **Φ3b** | T-beam **`b_eff`** (EC2 §5.3.2.1) — section property + report + flexural-cap (sagging→b_eff) | ✅ **IMPLEMENTED** (UNCOMMITTED) |
| Φ3c | Soffit step finish/rebar clip (ορατός σοβάς+οπλισμός κόβονται στο soffit) + I-shape steel clip | DEFER |
...
- **2026-06-26 (Φ3c-A — `b_eff` read-only γραμμή στο ΑΡΙΣΤΕΡΟ panel δοκού, UNCOMMITTED)** — Giorgio order
