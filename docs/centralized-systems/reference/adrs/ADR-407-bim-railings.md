...
| Field | Value |
|---|---|
| Status | 🟢 **Φ1 DONE (vertical slice)** — standalone path-based `RailingEntity` (Revit System Family / `IfcRailing`) end-to-end: types+Zod, enterprise-id, 2-click 2Δ tool + renderer, persistence+audit, **units-safe 3Δ converter** (InstancedMesh balusters + posts + TubeGeometry rails), discipline visibility (ADR-405), ΑΤΟΕ BOQ running-length. Φ2–Φ7 (hosting/handrail-separation/infill/Type-UI/stair-migration) εκκρεμούν. (2026-06-02, Opus 4.8) |
| Date | 2026-06-02 |
...
| **Φ7** | **Migration** `StairHandrails` → `RailingEntity` (stair handrail γίνεται hosted railing· retire ο tube). | Ενοποίηση SSoT |
