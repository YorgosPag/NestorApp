...
- **2026-07-04 (ε)** — **Grip Alt-move AutoAlign parity (4ος consumer, generic base-point)**: όταν ο χρήστης
  ...
  `hooks/tools/useGripGhostPreview.ts`. Σχετικά jest GREEN (44/44· 1 ΠΡΟΫΠΑΡΧΟΥΣΑ αστοχία mock στο
  `grip-commit-alt-bypass`, άσχετη — commit path, όχι tracking· επιβεβαιώθηκε με stash των 2 αρχείων). UNCOMMITTED.
