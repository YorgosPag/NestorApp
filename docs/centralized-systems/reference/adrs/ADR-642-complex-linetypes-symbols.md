...
- **Spread γύρω από το band centre**, ΟΧΙ γύρω από το 0 — reuse του υπάρχοντος `centerOffsetForLayer`
  (Φ5-A UX): έτσι ασύμμετρος compound (π.χ. ράγες 0/+1.5) κλιμακώνεται συνεκτικά. Τα solid rails μένουν
  συμμετρικά ως προς τον άξονά τους.
