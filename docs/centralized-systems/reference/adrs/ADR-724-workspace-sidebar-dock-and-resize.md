...
| Πεδίο | Τιμή |
|---|---|
| **Status** | 🟢 **Φ0 + Φ1 + Φ2 + Φ4/§9.1 IMPLEMENTED** — αγκυρωμένη παλέτα **αριστερά ή δεξιά** με αλλαγή πλάτους (δείκτης **και** πληκτρολόγιο)· οι δύο καμβάδες ακολουθούν· το **περιεχόμενο** προσαρμόζει πλέον την πυκνότητά του στο πλάτος της παλέτας (container queries, §14.6). Απόδοση **μετρήθηκε** (§4.3.1): το σύρσιμο κοστίζει ~0 ⇒ καμία cheap-path. **Φ3 (αιωρούμενη): NOT IMPLEMENTED** — η μόνη από τις τρεις λειτουργίες του §13 που λείπει. **Φ4/§9.3 + §9.2: NOT IMPLEMENTED.** Ανέλεγκτα ζωντανά: **mobile drawer** (§14.2), **οπτικό πέρασμα Φ4** (§14.6) |
| **Date** | 2026-07-28 (Φ0/Φ1) · 2026-07-29 (Φ2, Φ4 §9.1) |
