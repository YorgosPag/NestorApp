...
- **Scope**: Properties subapp read-only floorplan tab — show BIM entities (`walls`, `slabs`, `beams`, `columns`, `openings`, `slab-openings`, `stairs`) drawn in the DXF Viewer subapp.
