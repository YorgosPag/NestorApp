...
| **Φ3.1γ** | **Μνήμη κανόνων** (project→company override) — scoped library + enterprise id + rules/indexes/audit· αυτόνομο πάνελ λίστας εισαγόμενων με badge | «μία φορά το δηλώνω, δεν ξαναρωτιέμαι» | ⬜ TODO |
