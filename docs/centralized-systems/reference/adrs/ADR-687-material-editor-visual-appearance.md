...
**Status:** 🟢 Φ1 + HDR-studio-preview + Φ4 + Φ5 (clearcoat/transmission) + Φ6 (rendered swatch thumbnail) + Φ7 (textured sphere thumbnails για ΟΛΑ τα swatches) IMPLEMENTED (2026-07-23/24, Opus 4.8· **UNCOMMITTED** — εκκρεμεί browser verify + commit Giorgio). Φ2/Φ3 = PROPOSED.
