...
- Aggiornare `.ssot-registry.json` con **8 nuovi moduli**: `StairGeometryService`, `stair-validator`, `geometry-offset-utils`, `geometry-curve-utils` *(Phase 2a spiral+helix DONE 2026-05-16; ellipse arrivera Phase 2b)*, `stair-grips`, `stair-transforms`, `stair-presets-service`, `stair-schedule-exporter`.
