...
### 28.11.7 Ρητά όρια — χρέος, όχι παράλειψη
...
- **Νέα/επεκταμένα**: `table-text-decoration` (14) · `font-file-kind` (10) · `table-export-parity`
  (+7) · `dxf-table-style-fidelity` (+5) · `table-typography-paint` (+1, 1 διορθωμένο) ·
  `scene-vector-emitter` (+4).
- **Κάθε νέο test με μετάλλαξη** — δες §28.11.9.
- `jscpd:diff` καθαρό στα αρχεία του βήματος.
