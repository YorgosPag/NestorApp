...
🔴 **ΕΚΚΡΕΜΕΙ Η ΖΩΝΤΑΝΗ ΕΠΑΛΗΘΕΥΣΗ (κανόνας §28.9.8)**: εξαγωγή DXF → άνοιγμα σε **AutoCAD
2021**. Χωρίς αυτό το βήμα 4 **δεν κλείνει**. Η Φ1 είχε 2.642 tests πράσινα και αρχείο όπου
τίποτα δεν φαινόταν. **Το όργανο της επαλήθευσης παραδόθηκε — §28.11.10.**
