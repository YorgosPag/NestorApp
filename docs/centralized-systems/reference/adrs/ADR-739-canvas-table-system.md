...
ότι θα το **δει**. Η τελευταία υπεράσπιση κατά της σιωπηλής καταστροφής παραμένει η **Φάση 4**,
που τρέφεται από το **ίδιο** σχέδιο.
...
- 🔴 **Ο διάλογος «θα σβηστούν δεδομένα;» ΔΕΝ υπάρχει ακόμη** — είναι η **Φάση 4**. Το
  κατηγόρημα `tableRangeTransferOverwrites` υπάρχει και **δεν καλείται**: σήμερα η απόθεση πάνω
  σε γεμάτα κελιά **αντικαθιστά χωρίς ερώτηση**.
