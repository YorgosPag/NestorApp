...
| 7 | κτίριο χωρίς έργο | ⛔ **δεν έγινε**: και τα 7 κτίρια της εταιρείας έχουν `projectId` · απόφαση Giorgio: **δοκιμαστικό κτίριο** χωρίς έργο, που σβήνεται μετά από την εφαρμογή — εκκρεμεί | — |
...
- ⏳ **Ζωντανή επαλήθευση Β9–Β13 + βήματα 3 και 7: εκκρεμεί** (Chrome + Firestore · ERGO TEST · δοκιμαστικό κτίριο χωρίς έργο, απόφαση Giorgio).
