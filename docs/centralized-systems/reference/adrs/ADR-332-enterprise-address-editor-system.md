...
- 🔶 **Ο `AddressMapCandidateLayer` δεν έχει άγκυρα απόδοσης**: εισάγει `maplibre-gl`, που
  ...
  μπορεί να είναι λάθος σιωπηλά)* είναι πλήρως αγκυρωμένη ξεχωριστά· η **σύνθεση**
  επαληθεύτηκε με **περπάτημα οθόνης**. Ένα περιβάλλον με WebGL θα ήταν δική του απόφαση.
