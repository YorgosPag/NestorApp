...
|--------|------|--------|----------|
| ✅ **Phase A DONE** · ✅ **Phase B.1 DONE** · ✅ **Phase B.2 DONE** · ✅ **Phase B.3 DONE** · 🩹 **Phase B Runtime Wiring HOTFIX 2026-05-26** · ✅ **Phase C.1 DONE 2026-05-26** · ✅ **Phase C.2 DONE 2026-05-26** | 2026-05-25 / 2026-05-26 | Giorgio Pagonis + Claude (Sonnet 4.6 / Opus 4.7) | **Full Revit Clone — Enterprise — Unified SSoT with ADR-358** |
...
- Per-view overrides (Visibility/Graphics) — pending
- Per-element overrides — pending
- Layer-driven overrides (integrate ADR-358) — pending
- 3D parity (ADR-370): same SSoT → THREE.js line widths — pending
