...
**Status:** ⛔ **ΥΠΟΒΙΒΑΣΜΕΝΟ ως θεραπεία απόδοσης (2026-07-29 δ)** — η διάγνωσή του αναιρέθηκε από το
**δικό του** όργανο. **Φ0.1 (attribution) ΥΛΟΠΟΙΗΜΕΝΗ και χρήσιμη** · **Φ1 ΥΛΟΠΟΙΗΘΗΚΕ (2026-07-29 ε)**
ως ανεξάρτητη διόρθωση ορθότητας/parity (Revit/AutoCAD), **όχι** ως θεραπεία απόδοσης — βλ. Changelog ·
**Φ2–Φ5 ΔΕΝ ΥΛΟΠΟΙΟΥΝΤΑΙ** (καμία μέτρηση δεν τις δικαιολογεί) · Ο πραγματικός ένοχος για το frame
budget: **ADR-726 §6 Φ3** (bitmap cache).
