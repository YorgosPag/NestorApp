...
Ισοδυναμία 100% αποδεδειγμένη διαφορικά (§5 Φ2 «Τι υλοποιήθηκε»)· **ΕΚΚΡΕΜΕΙ η production
μέτρηση-απόδειξη** (`snap:ENTITIES` πριν/μετά + `snap:BROAD`). **Φ4/Φ5 ΠΑΡΑΜΕΝΟΥΝ ΑΝΕΝΕΡΓΕΣ**
— το «⛔ ΥΠΟΒΙΒΑΣΜΕΝΟ (δ)» ισχύει πλέον **μόνο** για αυτές.
