...
- **Status**: 🟢 ACCEPTED — **Phase A + B1 + B2 + B3a + B3b + B3c DONE** (A: 2026-05-30 resolver SSoT + τύποι + Zod· B1: 2026-05-31 host-plan builder SSoT + 2D section full-profile· B2: 2026-05-31 stepped/sloped 3D solid + syncWalls wiring + tests· B3a: 2026-05-31 profile-aware `computeWallGeometry` area/volume/bbox + BOQ feed· **B3b: 2026-05-31 ETICS Z1 ΠΛΗΡΕΣ ΣΚΑΛΩΤΟ ΚΕΛΥΦΟΣ (per-edge variable top 3D + profile-aware BOQ area + `buildWallHostInputs` SSoT extract)· B3c: 2026-05-31 2D cut-state = no-op confirmed + doc**). Phase C–F εκκρεμούν.
- **Date**: 2026-05-30
