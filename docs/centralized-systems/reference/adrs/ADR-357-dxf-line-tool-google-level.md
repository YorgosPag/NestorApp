...
- **Right-click su grip hot** = context menu universale `Stretch / Move / Rotate / Scale / Mirror / Exit` con check-mark sul mode attivo. **Phase 11 deliverable** (2026-05-18): `GripContextMenuStore` + `GripContextMenu.tsx` + controller. `Base Point / Copy / Reference / Undo` deferiti a Phase 12 quando backing systems disponibili (NO stub silenziosi — pulizia UX GOL).
- **Mode behaviors**:
