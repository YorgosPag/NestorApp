...
- **Status**: IN PROGRESS (v2 — Slice 0 data model DONE· Slice 1 `pad` full 2Δ+3Δ DONE· Slice 1b selection + parametric grips DONE· **Slice 1-persist Firestore persistence DONE** — pending browser-verify + commit + deploy rules/indexes)
- **Date**: 2026-06-10
...
- `pad`: center, rotation, width/depth handles (mirror `column-grips` rectangular).
