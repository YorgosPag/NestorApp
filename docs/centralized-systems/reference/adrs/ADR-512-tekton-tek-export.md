...
**Status:** 🟢 Φάση 1 (τοίχοι) **BROWSER-VERIFIED στον Τέκτονα** 2026-06-21 — UNCOMMITTED. 🟡 Φάση 2 (κουφώματα→nested `<open>`) **CODE+TESTS COMPLETE** 2026-06-21, UNCOMMITTED — 🔴 browser-verify+commit. Έπιπλα: BLOCKED (βλ. DEFER). Commit μόνο Giorgio.
...
## Εκκρεμότητες / DEFER
- 🔴 **browser-verify (Τέκτων) Φ2**: τοίχος+πόρτα+παράθυρο → θέση/πλάτος/ποδιά/υπέρθυρο σωστά· πιθανή **micro-calibration** του opening normal-offset (το δείγμα έδειξε origin≈centerline ±25mm, κάσα/ποδιά) + επιβεβαίωση style→door/window σύμβολο.
