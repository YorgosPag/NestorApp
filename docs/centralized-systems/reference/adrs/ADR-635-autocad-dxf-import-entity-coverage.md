...
- Το πάνελ επιπέδων δείχνει 2178 ενώ `scene.entities.length` = 2295: **timing gap μέτρησης**, όχι απώλεια — το
  `reconcileLoadedSceneBim` αφαιρεί σύγχρονα τους hatches και επιστρέφουν **ασύγχρονα** από το Firestore
  `onSnapshot` (`merge-docs-into-scene.ts:186`), ενώ το πάνελ δεν ξαναμετρά. Ο `layerId` μηχανισμός επαληθεύτηκε
  σωστός σε parse/save/load/hydration. Χαμηλή προτεραιότητα.
