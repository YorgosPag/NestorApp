...
| **Phase 4** | Camera & ViewCube ENRICHMENT (tumble, 12-direction canonical snap, animated transitions, A.4/A.5/A.6/A.7 keyboard + accessibility impacts) — **see breakdown §4.5.1** | ~23-25h (από αρχικά ~6h base + ~17-19h από Appendix A impacts) | Phase 0 | 🟡 **IN PROGRESS** — 4.0 ✅ DONE (2026-05-21) · 4.1 ✅ DONE (2026-05-21) · 4.2–4.6 ❌ pending |
