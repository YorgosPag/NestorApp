...
| **GenArc Sub-Catalogs** | **`SPEC-3D-004A`** ✅ (Viewport — 45 files catalogued 2026-05-19), **`SPEC-3D-004B`** ✅ (DXF Parser — 8 files, ZERO port, 2026-05-19), `SPEC-3D-004C` (Utils/Snap/Picking — pending), `SPEC-3D-004D` (Geometry Helpers — pending), `SPEC-3D-004E` (Materials/Shaders — pending) |
...
| **SPEC-3D-004C** | Utils / Snap / Picking / Coordinate transforms | `utils/` (44 files) + `engines/snap/` (7 files) | ⏳ pending session | TBD |
