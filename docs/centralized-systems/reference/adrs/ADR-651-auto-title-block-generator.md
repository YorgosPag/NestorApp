...
- **Status**: 🟡 IN PROGRESS — **Φάσεις Α (data wiring) + Β (in-scene insert) + Γ (κορνίζα ISO 5457,
  parametric reflow, βιβλιοθήκη presets) + ΣΤ (εκτύπωση/εξαγωγή — WYSIWYG: οθόνη === PDF === DXF) +
  Ε (σφραγίδα-εικόνα + rule-based έλεγχος πληρότητας + νέο `ImageEntity`) ΥΛΟΠΟΙΗΜΕΝΕΣ**
  (2026-07-13)· Φάσεις Δ (AI), Ζ (multi-sheet) εκκρεμούν
- **Date**: 2026-07-13
