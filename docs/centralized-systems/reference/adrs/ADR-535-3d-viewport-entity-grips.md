...
**Status:** 🟢 Φ1+Φ2+Φ3a+Φ3b+Φ4(hide-gizmo+context-menu)+Φ5(2D-overlay)+Φ5b(GPU depth occlusion)+Φ6(twin top/bottom grips) IMPLEMENTED (UNCOMMITTED) · Φ4 (edit-mode toggle) DEFER · **Date:** 2026-06-26
...
| **Φ8+ (δοκάρια/θεμέλια)** | Υπόλοιπες οικογένειες Δομικών, Plan Mode ανά μία (ίδιο pattern) | TODO |
