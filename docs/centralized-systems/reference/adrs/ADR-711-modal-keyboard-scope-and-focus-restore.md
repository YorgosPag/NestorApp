...
| **Συνοδοί**: κάθε `FloatingPanel` (σήμα στη ρίζα του) · `[data-sonner-toaster]` · το dev overlay | Ό,τι ζωγραφίζεται **πάνω** από την επιφάνεια πρέπει να πατιέται — ένα αδρανές πλωτό πάνελ είναι «κουμπί που δεν ακούει» (ADR-724 §14.9). Οι ειδοποιήσεις μένουν ζωντανές — κάτι που ο Radix δεν κάνει. |
