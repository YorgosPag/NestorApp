...
- **2026-09-16** — **G13 / CHECK 12: ΜΗΧΑΝΗ ΠΟΛΙΤΙΚΗΣ ΑΔΕΙΩΝ — η πύλη έβλεπε 12% του γράφου, και το ψευδές της μήνυμα έκρυβε άλλη αιτία.**
  ...
  🔶 **Εκτός αντικειμένου, ανοιχτά**: THIRD_PARTY_NOTICES για ό,τι φτάνει στον browser · σάρωση devDependencies · αφαίρεση devDep `license-checker` (θέλει `pnpm install`) · εξάλειψη `buffers`/`binary` (το exceljs 4.4.0 καρφώνει `unzipper ^0.10`) · επαλήθευση «server-side μόνο» για το sharp.
