...
| `\C` / `\c` (χρώμα) | ✅ | ✅ | ⚠️ **`ByLayer`/`ByBlock` δεν επιβιώνουν του round-trip** — γράφονται σωστά ως `\C256;`/`\C0;` αλλά ο tokenizer τα ξαναδιαβάζει ως `ACI 256`/`ACI 0` (ADR-737 §11-6, ανοιχτό) | ✅ |
