...
| `\A` (vertical align) | ✅ (πάντα) | ✅ **από ADR-737** | ✅ **από ADR-737** | ❌ **κανένας renderer δεν το διαβάζει** |
| `^I` / `^J` / `^M` | ✅ | ✅ | ✅ | ✅ |
| `\\` `\{` `\}` | ✅ **από ADR-737** | ✅ | ✅ | ✅ |
...
σιωπηλά**. Το ADR-737 πρόσθεσε `TextRunStyle.verticalAlign?: 0|1|2` (διατήρηση + εκπομπή), αλλά
**η οπτική εφαρμογή παραμένει ΑΝΟΙΧΤΗ**: οι 49 εμφανίσεις **δεν μετακινούν χαρακτήρα στην οθόνη**.
Μην το χαρακτηρίσετε «υποστηριζόμενο» χωρίς αυτή τη διάκριση.
