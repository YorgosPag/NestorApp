...
| **A** | A2 | Commands (Create/Update/Delete/Explode + ArrayStore) | ⏳ pending | ~5 new | ~30 min | — |
| **A** | A3 | Rendering + Snap + Selection integration | ⏳ pending | ~6 new/modify | ~45 min | — |
| **A** | A4 | Ribbon + Tool + Edit Source mode + Dialogs (Phase A SHIPS) | ⏳ pending | ~10 new/modify | ~60 min | — |
| **B** | B1 | Polar math + command + tool registration | ⏳ pending | ~5 new/modify | ~30 min | — |
