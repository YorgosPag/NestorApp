...
> **2026-05-19 Update**: Phase 4.5c.4 implemented snap-to-wall-corners + grid-intersections visual feedback — see § Phase 4.5c.4 below. Remaining items (beam-end auto-snap, drag-time dim annotations) still deferred.
...
- Beam-end auto-snap σε column anchors (Phase 5.5c cross-dep — requires exposed anchor API from column geometry).
- Full drag-time dimension annotations (requires GripInteractionStore leaf — separate ADR-040 compliant leaf component).
...
- [ ] **Deferred Phase 5.5d+**: auto-connect to columns (beam ends snap to column anchors), snap-to-wall-axis / column-center integration, beam-supports-slab analytical link (Phase 6 BOQ dependency), section-profile preview overlay για variant materials (steel I/H profiles).
...
**Deferred to Phase 5.5d+:** auto-connect to columns, snap-to-wall-axis / column-center integration, beam-supports-slab analytical link (Phase 6), section-profile preview overlay για steel I/H profiles.
