...
- [ ] **Deferred Phase 5.5i+**: beam-supports-slab analytical link (Phase 6 BOQ dependency). Distinct BIM snap labels for wall/slab/opening ("Επί άξονα τοίχου" / "Επί ακμής πλάκας" / "Επί παραστάτη ανοίγματος") already implemented (Phase A, NearestSnapEngine + PerpendicularSnapEngine).
