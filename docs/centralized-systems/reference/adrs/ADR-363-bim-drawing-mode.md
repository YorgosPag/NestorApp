...
- [ ] **Deferred Phase 3.5**: slab-opening separate entity (§11.Q3), vertex grips για polygon edit, rectilinear constraint Shift toggle, hatch patterns, maxFreeSpan analytical (1D beam-direction), `UpdateSlabParamsCommand` full undo/redo.
