...
- [ ] **Deferred Phase 5.5i+**: column-center-line 3D wireframe snap, distinct i18n snap labels ("Επί άξονα τοίχου" / "Επί ακμής πλάκας" / "Επί παραστάτη ανοίγματος"), beam-supports-slab analytical link (Phase 6 BOQ dependency).
