...
- [ ] Delete path — `WallFirestoreService.deleteWall()` exists (Phase 1B) but no delete UI exposed yet; `recordWallChange('deleted', ...)` wired when delete ribbon action lands (Phase 1E+).
