...
- Snap-to-slab-edge perpendicular (mirror του wall axis snap για slab outline edges — Phase 3 dependency, currently slabs feed endpoints/midpoints only).
- Snap-to-opening-jamb perpendicular (door/window frame vertical edges — Phase 2 host-aware snap).
