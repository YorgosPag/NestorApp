...
- [ ] **Deferred Phase 4.5c.2+**: hatch patterns per material category, snap-to-wall-corners + grid-intersections integration, section-profile overlay για L/T variants ενώ γίνεται drag.
