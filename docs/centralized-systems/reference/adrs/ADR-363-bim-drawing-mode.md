...
- [ ] **Deferred Phase 5.5b+**: width/depth dimension grips, hatch patterns per material (RC/steel/glulam), auto-connect to columns (beam ends snap to column anchors), snap-to-wall-axis / column-center integration, beam-supports-slab analytical link (Phase 6 BOQ dependency).
