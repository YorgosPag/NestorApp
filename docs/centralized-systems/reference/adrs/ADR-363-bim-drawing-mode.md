...
- [ ] **Deferred Phase 4.5b**: hatch patterns per material category, variant-specific arm/flange grips (L-shape, T-shape), anchor cycling visual preview (ghost at all 9 positions), snap-to-wall-corners + grid-intersections integration.
