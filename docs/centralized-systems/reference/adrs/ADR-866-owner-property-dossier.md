...
- ⏳ **Η διόρθωση Β5/Β4/Π4 ΔΕΝ έχει δοκιμαστεί ζωντανά** — χρειάζεται commit + push. Έλεγχος: ένα ανέβασμα στις «Φωτογραφίες»
  και ένα στο «Τοπογραφικό» ⇒ εμφάνιση **χωρίς** «Ανανέωση» · επιλεγμένη κάρτα ορατή στο σκοτεινό · δεύτερο «Ανέβασμα αρχείου» δεν κλείνει.
