...
|---|----------|------|----------|----------|--------|--------|
| 1 | Firestore Rules — Tenant Isolation | [SPEC-255A](./specs/SPEC-255A-firestore-rules-tenant-isolation.md) | 2 collections (+ 1 prerequisite fix) | **P0** | 2h | 📋 PLANNED |
| 2 | API Route Tenant Checks | [SPEC-255B](./specs/SPEC-255B-api-route-tenant-checks.md) | ~20 routes missing checks | **P0** | 4h | 📋 PLANNED |
...
| 5 | Financial Audit Trail | [SPEC-255E](./specs/SPEC-255E-audit-trail-financial-ops.md) | ~15 transitions + ~35 DELETEs | **P1** | 6h | 📋 PLANNED |
| 6 | Cleanup Test Endpoints | [SPEC-255F](./specs/SPEC-255F-cleanup-test-endpoints.md) | 1 endpoint | **P0** | 0.5h | 📋 PLANNED |
...
- **Χρειάζεται**: `requireUnitInTenant()`, `requireStorageInTenant()`, `requireParkingInTenant()`
...
- **Χρειάζεται**: `logFinancialTransition()`, `logEntityDeleted()`
