...
**Reuse (μηδέν νέα detection/flush/geometry):** `beamFramesColumn` + `projectColumnFootprintOnAxis`
(ADR-494), `rotateVector` → `rotatePoint` (ADR-188), `centredPolyToWorld` (ADR-363 Slice F).
