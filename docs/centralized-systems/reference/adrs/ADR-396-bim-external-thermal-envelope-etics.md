...
- **Gate 2 — no-slab-data default (αίθριο vs δωμάτιο):** όταν `slabsAbove` είναι **κενό** (καθόλου
  ...
  ανιχνεύονται όταν δοθούν `slabsAbove` (cross-floor) και η κάλυψη < threshold — **Φάση 5C scaffold DONE** (SSoT store + producer `useEnvelopeFloorSlabs` + `resolveSlabsAboveForLevel`)· consumer wiring εκκρεμεί.
...
> verify. **Deferred Φάση 5C:** cross-floor `slabsAbove` wiring (2D+3D μαζί) → ανίχνευση αίθριου. **Φάση 6:**
> UI override panel για `envelopeFunction`.
