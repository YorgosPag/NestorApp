...
άλλαξε (επαληθεύτηκε με ξανα-ανάγνωση). ⇒ Η άρνηση είναι καρφωμένη **στα πεδία**, όχι στο ποιος ρωτάει· τα δύο
βήματα του §7 #1 **δεν αυτοματοποιούνται** — η κονσόλα είναι ο **μόνος** δρόμος.
