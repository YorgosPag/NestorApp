...
⚠️ **Ανοιχτό — δεν αποφασίστηκε**: τα **13** υπο-στοιχεία δεν μετριούνται πλέον **πουθενά**.
Είναι υπερασπίσιμο *(ένα κλειστό accordion δεν «έχασε» τίποτα οπτικά)*, αλλά αν θέλουμε
πλήρη συμμόρφωση με το Α-3, χρειάζεται **δικός του δείκτης μέσα σε κάθε ανοιγμένο γονιό**
*(«−7 εδώ»)* — NN/g: ο δείκτης δίπλα στην περιοχή που αφορά, το ίδιο σκεπτικό που έβαλε
ξεχωριστό δείκτη στο dashboard. Ερώτημα προς τον Γιώργο.
