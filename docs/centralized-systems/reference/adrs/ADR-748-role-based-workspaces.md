...
| | |
|---|---|
| **Κατάσταση** | 🟢 **ΦΑΣΕΙΣ 1 & 2 ΥΛΟΠΟΙΗΜΕΝΕΣ** (2026-08-02) — μητρώο δουλειών + φίλτρο ribbon με ορατό διακόπτη ειδικότητας. Φάση 0 (ευρήματα + Ε-1…Ε-7) έκλεισε. Επόμενο: Φάση 3 (sidebar + dashboard). |
...
| **2** | Φίλτρο ribbon στον DXF viewer **+ ο ορατός διακόπτης ειδικότητας** (Ε6.β) | ~4 αρχεία | **Μέγιστο κέρδος, ελάχιστο κόστος** — τα tabs είναι ήδη ανά ειδικότητα (§2.5). ⚠️ **Χωρίς τον διακόπτη η φάση είναι ΑΝΕΠΑΛΗΘΕΥΤΗ**: ο `super_admin` δικαιούται και τα 16 (Ε4.ε) ⇒ βλέπει «καμία αλλαγή»· και ο viewer έχει **0** αναφορές auth (§2.4) |
