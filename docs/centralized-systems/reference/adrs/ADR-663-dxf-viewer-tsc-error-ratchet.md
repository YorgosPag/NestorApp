...
| 2026-07-16 | 61 | −10 | Part 4: `DialogContent size="md"` (3 files, live full-width layout bug) + `createEntityFromTool` declared with the preview union (7 errors, 3 files) |
...
### 2026-07-16 batches, part 4 (71 → 61)

Start-of-session full run: **71** source errors (part 3 ended at 67 + 3 `Block*Dialog` never previously grouped + 1 foreign `entity-export-coverage`). Two roots closed, **10 errors**, and **two live bugs** — again both were *type errors that were hiding broken features*, not noise.
