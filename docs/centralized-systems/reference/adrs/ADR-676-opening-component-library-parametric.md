...
- **Status**: 🟢 PARTIAL IMPLEMENTED (Phase 3 — πιλότος frame/casing user-library, **ΒΗΜΑ 1 = ορθογώνιο**, υλοποιήθηκε 2026-07-18. ΒΗΜΑ 2 = realistic `section` outline + επόμενα εξαρτήματα handle/hinge/glazing = εκκρεμούν)
