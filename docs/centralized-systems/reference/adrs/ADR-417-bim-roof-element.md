...
- **Status**: 🟢 ACCEPTED + 🟡 Φ1 + Φ1-part-2 #1/#2/#3/#4/#5/#8 IMPLEMENTED (2026-06-04→05, Opus) — entity+engine+2D+3D+tool+persistence+RoofTypes(built-ins)+BOQ+ribbon+i18n DONE· **contextual-tab + grips + V/G category(✅browser-verified) + audit + icon + Family-type UI (edit-dialog/auto-assign/re-resolution/override/delete-detach/typeId-persistence) DONE (2026-06-05)**· **Φ2a (hip+rounded caps) + Φ2b (γείσο: overhang/fascia/soffit persisted+2D) DONE (2026-06-05→06)**· εκκρεμή: contextual-tab tests (#6 μερικώς) (βλ. §10). 🔴 browser-verify + commit pending.
- **Date**: 2026-06-04
