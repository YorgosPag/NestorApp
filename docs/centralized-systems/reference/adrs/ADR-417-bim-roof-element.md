...
7. 🟡 **Φ2a DONE (2026-06-05, Opus — Plan Mode phased)** — **Hip (τετράρριχτη)** + rounded εφαπτόμενοι κορφιάδες (3D). Υλοποιήθηκε με **γενικό lower-envelope N-plane solver** (`roof-lower-envelope.ts` — όχι straight-skeleton· convex footprints) αντί special-case· caps που κάθονται στις 2 κλίσεις (`roof-ridge-cap.ts`). 45/45 tests, tsc 0. 🔴 browser verify + commit. **Φ2b pending:** γείσο overhang/fascia/soffit persisted + 2D κάτοψη. (βλ. §9 changelog 2026-06-05 Φ2a.)
