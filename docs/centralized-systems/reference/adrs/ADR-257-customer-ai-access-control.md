...
| Documents | ✅ READ | Δικά μόνο | Ενεργειακό, κατόψεις, contracts, Συγγραφή Υποχρεώσεων |
| Ραντεβού | ✅ READ/WRITE | Δικά μόνο | Κλείσιμο, ακύρωση |
...
| Ραντεβού (γενικά) | ✅ READ/WRITE | Μόνο γενικά, ΟΧΙ για προβλήματα |
| Τιμές | ❌ | — |
| Πληρωμές | ❌ | — |
| Legal | ❌ | — |
| Κατασκευή | ❌ | — |
