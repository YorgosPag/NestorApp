...
⚠️ **ΕΚΚΡΕΜΕΙ ΕΠΑΛΗΘΕΥΣΗ ΜΕ ΜΕΤΡΗΣΗ** — ίδιο πρωτόκολλο με τη Φ5 (§ΦΆΣΗ 5 + HANDOFF
2026-07-30 §4)· κριτήριο επιτυχίας: εξαφάνιση των >70ms `frame:dxf-canvas` εκτελέσεων μέσα σε
χειρονομία (οι εναπομείνασες ακριβές πρέπει να συμπίπτουν με idle/δομικά rebuilds).
