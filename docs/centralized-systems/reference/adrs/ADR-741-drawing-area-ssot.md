...
### 8.3 ⚠️ Τι **δεν** επαληθεύτηκε

Το **σύμπτωμα Α επαληθεύτηκε μόνο με tests** (η σειρά `save → clip → draw`), **όχι στην
οθόνη**: η επέκταση Chrome ήταν αποσυνδεδεμένη σε όλη τη διάρκεια. Τα tests αποδεικνύουν ότι
το clip εφαρμόζεται· **μόνο η οθόνη αποδεικνύει ότι ο χάρακας φαίνεται πια**. Εκκρεμεί
οπτικός έλεγχος: εργαλείο «Εικόνα» → ghost πάνω από τον αριστερό χάρακα → οι ενδείξεις
πρέπει να **παραμένουν ορατές**.
