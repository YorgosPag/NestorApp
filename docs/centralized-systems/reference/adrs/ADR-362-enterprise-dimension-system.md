...
| Field | Value |
|---|---|
| **Status** | 🟡 IN PROGRESS — Groups A-G done (F3/G1/G2/G3 pending commit), H1/H2/H3/I1/I2 done (pending commit), next: I3 (hit-testing) |
| **Date** | 2026-05-17 |
...
- **2026-05-18 (Phase I2 DONE — Grip editing: 5 grips per DimensionEntity, full drag commit.)** — AutoCAD-style grip editing wired into the unified grip system for all 10 `DimensionType` variants.
  ...
  - **Next**: Phase I3 — Hit-testing for DimensionEntity (geometry-aware proximity detection for click-select). ⬜ PENDING.
