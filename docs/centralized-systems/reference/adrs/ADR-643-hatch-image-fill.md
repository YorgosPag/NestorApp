...
## 9. Ανοιχτές Ερωτήσεις (Q&A — ΠΡΟΣ GIORGIO, πριν την υλοποίηση)

| # | Ερώτηση | Προτεινόμενο default |
|---|---|---|
| **Q1** | Πόσο μεγάλο; MVP (μόνο βάλε-εικόνα-ως-γέμισμα) ή πλήρες σύστημα (βιβλιοθήκη + upload + αρμοί + πραγμ. κλίμακα); | Πλήρες, σταδιακά (Φ1→Φ6) |
| **Q2** | Πηγή εικόνων: έτοιμη βιβλιοθήκη, upload, ή και τα δύο; | Και τα δύο |
| **Q3** | DXF export: υποβάθμιση σε solid (ασφαλές) ή export ως IMAGE entity (πιστό αλλά βαρύ); | Solid-downgrade + warning |
| **Q4** | Αρμοί (grout lines) πάνω από την εικόνα — ναι/όχι στη Φ1 ή αργότερα; | Αργότερα (Φ5) |
| **Q5** | Κλίμακα: πάντα δεμένη με πραγματική διάσταση tile (Revit/ArchiCAD) ή και «ελεύθερη»; | Πάντα πραγματική διάσταση |
