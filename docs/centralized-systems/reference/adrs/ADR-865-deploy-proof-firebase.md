...
> **Κατάσταση**: ✅ Υλοποιημένο (2026-09-16) · ✅ §10 ζωντανή επαλήθευση (2026-09-18) · ✅ §11 γραμμή παραγωγής — **ενεργή** (πρώτο πράσινο run `35426414076`, 2026-09-19· τα δικαιώματα **εγγραφής** του deployer **αμέτρητα** μέχρι την πρώτη πραγματική ανάπτυξη μέσα από τη γραμμή, δες Changelog) (`docs/deployment/firebase-pipeline.md`) · **Πύλη**: CHECK 3.86 · **Αφορμή**: ADR-864 Φ1β
