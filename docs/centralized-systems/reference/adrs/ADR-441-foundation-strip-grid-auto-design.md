...
**Status**: 🟢 IN PROGRESS — αποφάσεις LOCKED (2026-06-11), υλοποίηση σε slices. **Slice 0 + Slice 1 + Slice 2 DONE** (Slice 1 rules+indexes DEPLOYED). Εκκρεμεί Slice 3 (follow-on-move). Σχέδιο: §10.
**Date**: 2026-06-11
