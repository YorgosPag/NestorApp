...
**Status**: 🟢 IN PROGRESS — αποφάσεις LOCKED (2026-06-11), υλοποίηση σε slices. **Slice 0 + Slice 1 DONE** (Slice 1 rules+indexes DEPLOYED). Εκκρεμούν Slice 2 (εσχάρα από grid) / Slice 3 (follow-on-move). Σχέδιο: §10.
**Date**: 2026-06-11
