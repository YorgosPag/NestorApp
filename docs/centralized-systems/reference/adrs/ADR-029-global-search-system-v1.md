...
| 2026-04-22 | Claude (Sonnet 4.6) | SUMMARY (Phase D complete): 8 domini ripuliti (contacts, projects, buildings, properties, parking, storages, ai-pipeline, opportunities), 15 siti rimossi, 0 regression. Single-writer invariant enforced via Cloud Function triggers. `.ssot-registry.json` `search-index-config` allowlist aggiornato con `functions/src/search/search-config.mirror.ts`. ADR-029 entry in `adr-index.md` corretta (categoria: Search & Indexing, data: 2026-04-22). |
