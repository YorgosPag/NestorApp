...
export const NormalView: React.FC<DXFViewerLayoutProps> = (props) => {
  ...
  // 🏢 ENTERPRISE (2026-02-02): mouseCoordinates REMOVED
  // ToolbarStatusBar now uses CursorContext directly (SSoT - Single Source of Truth)
  // This eliminates duplicate mouse handling systems
