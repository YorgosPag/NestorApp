 ...
 *
 * ⚠️ Σερβίρεται κι αυτό ως `/_next/static/.retention.json`. Περιέχει **μόνο** git SHA,
 * ημερομηνίες και ονόματα hashed αρχείων — τίποτα που δεν φεύγει ήδη μέσα στα ίδια τα bundles.
 *
