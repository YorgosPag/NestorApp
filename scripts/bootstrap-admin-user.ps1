# ==============================================================================
# BOOTSTRAP ADMIN USER - ENTERPRISE SETUP SCRIPT
# ==============================================================================
#
# Script για την δημιουργία του πρώτου admin user με custom claims.
# Χρησιμοποιείται στην αρχή για setup του authorization system.
#
# Usage:
...
Write-Host "[BOOTSTRAP] BOOTSTRAP ADMIN USER - Enterprise Setup" -ForegroundColor Cyan
Write-Host "================================================================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "[RUN] Sending bootstrap request..." -ForegroundColor Cyan
...
try {
    ...
    Write-Host ""
    Write-Host "[SUCCESS] Message: $($response.message)" -ForegroundColor Green
    Write-Host ""
    Write-Host "================================================================================" -ForegroundColor Cyan
    ...
    Write-Host ""
    Write-Host "[TIP] TIP: It may take 1-2 minutes for the token to refresh" -ForegroundColor Yellow
    Write-Host ""
    ...
    Write-Host "   Go to: https://console.firebase.google.com/project/pagonis-87766/authentication/users" -ForegroundColor White
    Write-Host ""
    Write-Host "2. Check that BOOTSTRAP_ADMIN_SECRET is set in .env.local:" -ForegroundColor White
    Write-Host "   BOOTSTRAP_ADMIN_SECRET=dev-bootstrap-secret-2026" -ForegroundColor White
    Write-Host ""
    Write-Host "3. Verify localhost:3000 is running:" -ForegroundColor White
    Write-Host "   npm run dev" -ForegroundColor White
    Write-Host ""
    Write-Host "4. Check API health endpoint:" -ForegroundColor White
    Write-Host "   http://localhost:3000/api/admin/bootstrap-admin" -ForegroundColor White
    Write-Host ""
