...
describe('Β-Τ — η κλίμακα του μέτρου δεν μπορεί να εκφράσει παραβίαση WCAG', () => {
  ...
  it('Β-Τ1: οι ρόλοι υπάρχουν και είναι ΠΛΗΘΟΣ ΧΑΡΑΚΤΗΡΩΝ, όχι pixel', () => {
  ...
  it('Β-Τ2: ρόλος πάνω από 80 χαρακτήρες ⇒ το BUILD ΣΚΑΕΙ (WCAG 1.4.8)', () => {
