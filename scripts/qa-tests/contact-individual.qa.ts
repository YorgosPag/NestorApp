 ...
 *   Phase 5: VALIDATION — Rejection, edge cases, regressions
 *
 * Prerequisites:
...
const phases: QAPhase[] = [
  { name: 'Phase 1: CREATE (22 tests)',      tests: createTests },
...
async function main(): Promise<void> {
  ...
  console.log('║  Google Test Matrix: CREATE/UPDATE/DELETE/BATCH/REJECT  ║');
  console.log(`║  ${totalTests} tests across 5 phases                              ║`);
  console.log('╚══════════════════════════════════════════════════════════╝');
