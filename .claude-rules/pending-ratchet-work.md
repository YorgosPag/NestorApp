...
**STATUS: ACTIVE**
**Last updated:** 2026-05-25 — **ADR-376 Phase B.1 DONE**: Renumber Openings command (IMAGINiT-style). 6 new + 9 modified + 12 tests PASS. `markIsManual` flag added για industry-standard preserve-on-renumber (5/5 convergence). Annotate ribbon tab + contextual quick-action wired. ADR-376 §7 status table + §4.9 markIsManual semantics + §11 changelog v6. Pending: Phase B.2 (BOQ Schedule Mode C) + Phase C (draggable tag).
