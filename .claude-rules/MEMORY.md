...
## Pending Work
- 🔴 [ADR-369 BIM Elevation — Q&A Phase IN-FLIGHT](handoff-adr369.md) — **STATUS: ACTIVE** (2026-05-20). Q1+Q2+Q3+Q5 answered (4/10). Pending: Q2-multibuild, Q3-base-point, Q7-sloped, Q8-IFC, Q9-naming, Q10-migration. **READ HANDOFF FILE FIRST** if user mentions ADR-369 or elevation/storey/floor work. NO implementation until all 10 questions answered (user explicit).
