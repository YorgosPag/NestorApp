 ...
 * | `network_message_revisions` (Β7) | **κάθε μορφή πριν από επεξεργασία** | πλαστό ιστορικό διορθώσεων |
 * | `network_inbox` (§4.5, Β10) — **το γονικό** | *(κενό έγγραφο — η υποσυλλογή φρουρείται στη σουίτα)* | πλαστό «διαβάστηκε» ⇒ σβηστό badge |
 *
