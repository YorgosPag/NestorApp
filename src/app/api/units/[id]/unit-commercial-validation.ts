/**
 * Commercial transaction validation for unit reserve/sell operations.
 *
 * Validates the full hierarchy chain (Unit → Floor → Building → Project → Company)
 * and buyer contact eligibility before a unit can be reserved or sold.
 *
 * @module api/units/[id]/unit-commercial-validation
...
/**
 * Validates all preconditions for reserving or selling a unit.
 *
 ...
 *  5. Unit has an asking price > 0
 *  5b. Unit has area (net or gross) > 0
