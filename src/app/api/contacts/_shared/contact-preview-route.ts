 ...
 *
 * ─────────────────────────────────────────────────────────────────────────────
 * ΕΒΔΟΜΗ ΔΙΑΔΡΟΜΗ (2026-09-11, ADR-332 D27 Β-ΙΙ): `address-positions`
 * ─────────────────────────────────────────────────────────────────────────────
 * Δεν είναι «προεπισκόπηση επίπτωσης», αλλά έχει **ακριβώς** το ίδιο σχήμα: υπολογίζει
 * πάνω σε επαφή του καλούντος και **δεν γράφει**. Γι' αυτό φορά τον ίδιο εκτελεστή — ένα
 * δεύτερο αντίγραφο ταυτότητας/δικαιώματος/φύλακα θα ήταν ακριβώς το σχήμα των τεσσάρων
 * αφύλακτων που έκλεισε εδώ το §7octies.
 *
