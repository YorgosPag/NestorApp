 ...
 *
 * NOTE: Instagram DM API does NOT support Quick Reply buttons (they are silently
 * ignored). Feedback is collected via text-based emoji detection in the handler.
 *
