...
import routeSlice from '@/i18n/generated/routes/data-deletion__versions.el.json';
...
export default function DataDeletionVersionsPage() {
  return <LegalVersionsRoute document="data-deletion" />;
}
