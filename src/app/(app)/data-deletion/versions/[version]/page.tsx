...
import routeSlice from '@/i18n/generated/routes/data-deletion__versions__version.el.json';
...
export default function DataDeletionVersionPage() {
  return <LegalVersionRoute document="data-deletion" />;
}
