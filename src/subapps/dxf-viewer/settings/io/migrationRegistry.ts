...
// 🏢 ADR-065: Extracted migration transformation helpers
import {
  fixLinePropertyNames, fixTextPropertyNames, fixGripPropertyNames,
...
// Helper functions extracted to migration-helpers.ts (ADR-065)
