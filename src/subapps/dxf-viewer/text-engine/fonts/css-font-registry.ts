 ...
 * **`Liberation Sans`**, το οποίο το `CAD_SUBSTITUTE_FONTS` υλοποιούσε **τότε** με το φυσικό
 * `/fonts/Roboto-Regular.ttf` (από το **ADR-803**, 2026-08-25, το υλοποιεί με το πραγματικό
 * `/fonts/LiberationSans-Regular.ttf` — η αφήγηση παρακάτω περιγράφει το **ιστορικό**
 * ελάττωμα του ADR-786, ο μηχανισμός είναι ο **ίδιος**). Ο in-cell επεξεργαστής είναι **DOM**:
 * το `buildUIFont`
