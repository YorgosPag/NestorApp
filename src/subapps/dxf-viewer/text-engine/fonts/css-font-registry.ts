 ...
 * **`Liberation Sans`**, το οποίο το `CAD_SUBSTITUTE_FONTS` υλοποιεί με το πραγματικό
 * `/fonts/LiberationSans-Regular.ttf`. ⚠️ **Η αφήγηση παρακάτω είναι ΙΣΤΟΡΙΚΗ**: περιγράφει το
 * ελάττωμα του ADR-786, όταν το φυσικό αρχείο ήταν `Roboto-Regular.ttf` — εκείνο **διαγράφηκε**
 * στο **ADR-805 §9** (νεκρό, μηδέν καταναλωτές). Ο **μηχανισμός** είναι ο ίδιος και ισχύει.
 * Ο in-cell επεξεργαστής είναι **DOM**: το `buildUIFont`
