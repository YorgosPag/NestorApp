...
describe('entourage source resolvers — proxy URL shape', () => {
  ...
  it('φυτό: full/thumb με το δικό του pack id', () => {
    expect(resolvePlantsPlanUrl('pl-obj-001-1')).toBe(
      '/api/asset-packs/plants-plan-2d/v1/pl-obj-001-1.webp',
    );
    expect(resolvePlantsPlanUrl('pl-obj-001-1', 'thumb')).toBe(
      '/api/asset-packs/plants-plan-2d/v1/pl-obj-001-1.thumb.webp',
    );
  });
