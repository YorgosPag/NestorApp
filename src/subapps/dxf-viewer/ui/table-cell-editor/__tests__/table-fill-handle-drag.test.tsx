...
describe('🔴 ADR-754 §14.9 — η λαβή συμπλήρωσης, από το πάτημα ως το μοντέλο', () => {
  ...
  beforeEach(() => {
    ...
    entity = {
      ...entity,
      model: writeCellInput(entity.model, entity.model.rows[2].id, entity.model.columns[1].id, 'ΠΑΛΙΟ'),
    };
  ...
  describe('🔴 ΤΟ ΑΝΟΙΧΤΟ ΤΟΥ §14.9.2 — η συμπλήρωση ΕΚΤΕΛΕΙΤΑΙ', () => {
    ...
    it('πηγή η ΕΠΙΛΟΓΗ και όχι το ενεργό κελί — το μοτίβο επαναλαμβάνεται ολόκληρο', () => {
      ...
      // διαβάζει την ίδια πηγή με τον ζωγράφο. Δύο διαφορετικές τιμές, ώστε μια συμπλήρωση που
      // αντιγράφει μόνο το τελευταίο κελί να φαίνεται.
      entity = {
        ...entity,
        model: writeCellInput(entity.model, rowId(3), colId(1), 'ΝΕΟ'),
      };
      render(<FillHandleHarness entity={entity} onCommitModel={onCommitModel} />);
      navigateTo(2, 1);
      act(() => {
        setTableCellSelection({
