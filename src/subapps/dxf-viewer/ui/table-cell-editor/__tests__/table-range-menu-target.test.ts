 ...
 *
 * ## ⚠️ ADR-739 §43 — ΥΠΑΡΧΕΙ ΠΛΕΟΝ ΜΙΑ ΕΞΑΙΡΕΣΗ, ΚΑΙ ΔΕΝ ΕΙΝΑΙ ΕΔΩ
 * Το «*το δεξί κλικ δεν αγγίζει ποτέ την επιλογή*» έπαψε να είναι απόλυτο: το δεξί κλικ στο
 * **τετραγωνάκι της γωνίας** επιλέγει πρώτα ολόκληρο τον πίνακα, όπως μετρήθηκε στο πραγματικό
 * Excel (Giorgio, 04/08: με επιλογή `B2:C4`, *«χάθηκε η επιλογή σου κι επιλέχθηκε όλο το
 * φύλλο»*) και όπως αποφασίστηκε ρητά.
 *
 * 🔑 Ο κανόνας Α22 **δεν χαλάρωσε**: η γωνία δεν είναι κελί, οπότε δεν περνά ποτέ από αυτή τη
 * συνάρτηση. Ο κλάδος της ζει στο `use-table-range-menu.resolveTarget`, πριν από κάθε ερώτηση
 * κελιού, και το σκεπτικό της εξαίρεσης είναι γραμμένο εκεί.
 */
