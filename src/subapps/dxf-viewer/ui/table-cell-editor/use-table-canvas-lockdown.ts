 ...
 *
 * 🔴 **§40.1 — Η ΜΙΑ ΕΞΑΙΡΕΣΗ (2026-08-04): το ⊕ της εισαγωγής.** Ο οπλισμένος δίσκος παίρνει
 ...
 * το §40.1, δηλαδή ένα ακόμα νούμερο που παλιώνει σιωπηλά. Οι αριθμημένοι κλάδοι από κάτω
 * είναι η πηγή.
 *
...
function shouldBlock(
  ...
  // 5. 🔴 §40.1 — **ΤΟ ⊕ ΕΙΝΑΙ ΚΟΥΜΠΙ, ΚΑΙ ΤΑ ΚΟΥΜΠΙΑ ΔΕΝ ΜΟΙΡΑΖΟΝΤΑΙ ΤΟ ΠΑΤΗΜΑ.**
  //
