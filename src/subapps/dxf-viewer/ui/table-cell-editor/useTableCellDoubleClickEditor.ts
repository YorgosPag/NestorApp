...
export function useTableCellDoubleClickEditor(
   ...
   *
   * ⚠️ Οι συνθήκες των δύο ακροατών **δεν** είναι το `overlay !== null` του πληκτρολογίου
   * παραπάνω, και η απόκλιση είναι μετρημένη — δες τα σχόλια μέσα στο module.
   */
  useTableModeCanvasWiring({
    entity: liveEntity,
    hasEditorOverlay: overlay !== null,
    levelManager,
