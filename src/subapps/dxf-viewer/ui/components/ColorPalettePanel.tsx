...
export function ColorPalettePanel({ className = '' }: ColorPalettePanelProps) {
  ...
  // ✅ NEW: Sub-category state for grid lines (major lines, minor lines)
  ...
  // ✅ NEW: Handler for grid style (lines/dots/crosses)
  ...
  // ✅ NEW: Handlers for major grid settings
  ...
  // ✅ NEW: Handlers for minor grid settings
          ...
          <div className="p-4">
            ...
            {activeGridTab === 'grid' ? (
              <div className="space-y-4">
                ...
                {/* ✅ ΚΟΙΝΟ Grid Size (εμφανίζεται πάντα, ανεξάρτητα από sub-tab) */}
                <div className="p-2 bg-gray-700 rounded space-y-2">
                  <div className="text-sm text-white">
                ...
                {/* ✅ NEW: Grid Style Selector (ΚΟΙΝΟ για όλα τα styles) */}
                <div className="p-2 bg-gray-700 rounded space-y-2">
                  <div className="text-sm text-white">
                ...
                {/* ✅ NEW: Grid Lines Sub-tabs (Κύριες/Δευτερεύουσες) */}
                <div className="border-t border-gray-600 pt-4">
                  <div className="flex gap-1 mb-4 border-b border-gray-600 pb-2">
                    <button
                      onClick={() => setActiveGridLinesTab('major')}
                      className={`px-3 py-2 text-xs rounded-t transition-colors ${
                    ...
                    <button
                      onClick={() => setActiveGridLinesTab('minor')}
                      className={`px-3 py-2 text-xs rounded-t transition-colors ${
                        activeGridLinesTab === 'minor'
                          ? 'bg-green-600 text-white border-b-2 border-green-400'
                          : 'bg-gray-700 hover:bg-gray-600 text-gray-200'
                      }`}
                    >
                    ...
                    <div className="p-2 bg-gray-700 rounded space-y-2">
                      ...
                      <div className="flex items-center gap-2">
                        <div 
                          className="w-6 h-6 rounded border-2"
                          style={{ 
                            backgroundColor: getPreviewBackground(rulerSettings.horizontal.unitsColor || rulerSettings.horizontal.textColor || '#ffffff'),
                            borderColor: getPreviewColor(rulerSettings.horizontal.unitsColor || rulerSettings.horizontal.textColor || '#ffffff')
                          }}
                        />
                        <input
                          type="color"
                          value={getPreviewColor(rulerSettings.horizontal.unitsColor || rulerSettings.horizontal.textColor || '#ffffff')}
                          onChange={(e) => handleUnitsColorChange(e.target.value)}
                          className="w-8 h-6 rounded border-0 cursor-pointer"
                        />
                        <input
                          type="text"
                          value={rulerSettings.horizontal.unitsColor || rulerSettings.horizontal.textColor || '#ffffff'}
                          onChange={(e) => handleUnitsColorChange(e.target.value)}
                          className="w-20 px-2 py-1 text-xs bg-gray-600 text-white rounded border border-gray-500"
                          placeholder="#ffffff"
                        />
