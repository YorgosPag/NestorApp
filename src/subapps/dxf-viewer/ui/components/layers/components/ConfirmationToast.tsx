  ...
  return (
    <div className={`flex flex-col ${PANEL_LAYOUT.GAP.MD} ${PANEL_LAYOUT.SPACING.LG} max-w-md ${colors.bg.primary} ${PANEL_LAYOUT.ROUNDED.LG} ${PANEL_LAYOUT.SHADOW.LG} ${quick.card}`}>
      <div className={`flex items-start ${PANEL_LAYOUT.GAP.MD}`}>
        ...
        <div className={`${PANEL_LAYOUT.FLEX_SHRINK.NONE} ${PANEL_LAYOUT.MARGIN.TOP_XS}`}>
          {destructive ? (
            ...
            <div className={`${iconSizes.xl} ${colors.bg.secondary} ${PANEL_LAYOUT.ROUNDED.FULL} flex items-center justify-center`}>
      ...
      <div className={`flex ${PANEL_LAYOUT.GAP.SM} justify-end ${PANEL_LAYOUT.PADDING.TOP_SM} ${quick.separatorH}`}>
        <button
          onClick={onCancel}
          className={`${PANEL_LAYOUT.BUTTON.PADDING} ${PANEL_LAYOUT.TYPOGRAPHY.SM} ${PANEL_LAYOUT.FONT_WEIGHT.MEDIUM} ${colors.text.secondary} ${colors.bg.muted} ${HOVER_BACKGROUND_EFFECTS.GRAY_LIGHT} ${PANEL_LAYOUT.ROUNDED.MD} ${PANEL_LAYOUT.TRANSITION.COLORS} focus:outline-none ${colors.interactive.focus.ring}`}
        >
          {cancelText}
        </button>
        <button
          onClick={onConfirm}
          className={`${PANEL_LAYOUT.BUTTON.PADDING} ${PANEL_LAYOUT.TYPOGRAPHY.SM} ${PANEL_LAYOUT.FONT_WEIGHT.MEDIUM} ${PANEL_LAYOUT.ROUNDED.MD} ${PANEL_LAYOUT.TRANSITION.COLORS} focus:outline-none ${colors.interactive.focus.ring} ${
            destructive
