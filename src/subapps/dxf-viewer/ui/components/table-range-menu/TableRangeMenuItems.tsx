 ...
 * μητρώο + έξι χειριστές — δεν αγγίζουν ούτε την εστίαση, ούτε τον κύκλο ζωής του μενού, ούτε
...
/**
 * Οι **έξι** πράξεις που υπάρχουν σήμερα.
 *
 * Ένα αντικείμενο και όχι έξι props, για τον ίδιο λόγο που το ADR-750 έβαλε τα περιγράμματα σε
 * ένα: ο τύπος **είναι** το συμβόλαιο, και μια κατάσταση «τέσσερις από τις έξι» δεν πρέπει να
 * είναι εκφράσιμη.
 */
 ...
 * είναι ακριβώς ο μηχανισμός που κρατά γκρίζες τις εννιά εντολές χωρίς πράξη.
 */
