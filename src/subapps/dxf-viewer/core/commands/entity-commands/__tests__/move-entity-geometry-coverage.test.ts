...
const MOVE_GOLDEN = [
  ...
  'imported-mesh',
  // ADR-684 Φ2 — το παραμετρικό στερεό ΜΕΤΑΚΙΝΕΙΤΑΙ (μετασχηματισμός σημείου εισαγωγής·
  // το σχήμα δεν αλλάζει). case 'generic-solid' στο calculateBimMovedGeometry switch.
  'generic-solid',
] as const;
