 ...
 *
 * ⚠️ **Καμία λαβή ύψους ΑΝΑ γραμμή** — και είναι σκόπιμο: το πλήθος λαβών δεν επιτρέπεται να
 * είναι ανάλογο των δεδομένων (500 γραμμές ⇒ 500 λαβές ζωγραφισμένες + hit-tested ανά καρέ,
 * το σχήμα που πλήρωσε ο ADR-735). Το ύψος **μιας** γραμμής αλλάζει από τον επεξεργαστή κελιού
 * της Φ.Δ, όπου υπάρχει **μία** επιλεγμένη γραμμή (μοτίβο Excel/Figma)· το ύψος **όλων** τους
 * κλιμακώνεται αναλογικά από τις μεσοπλευρικές/γωνιακές λαβές παρακάτω — **8 σταθερές** λαβές,
 * όχι μία ανά γραμμή, άρα ο κανόνας του ADR-735 μένει ακέραιος.
 *
