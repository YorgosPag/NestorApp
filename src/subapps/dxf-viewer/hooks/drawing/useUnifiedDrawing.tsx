...
// 🏢 ENTERPRISE: Geometry utilities - only what's still needed in the hook (rest moved to extracted modules)
import {
  calculateDistance,
  circleBestFit,
...
import { generatePreviewEntity, applyPreviewStyling } from './drawing-preview-generator';
