...
import type { BimEntity, PlanBounds } from '../types/bim-base';
...
export interface FilterableBimEntity {
  ...
  readonly geometry: { readonly bbox: PlanBounds };
 ...
 */
function bboxesIntersect2D(a: PlanBounds, b: PlanBounds): boolean {
...
export function asFilterable(
  entity: BimEntity<string, unknown, { bbox: PlanBounds }>,
): FilterableBimEntity {
