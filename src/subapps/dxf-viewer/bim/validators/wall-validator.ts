 ...
 */
export function validateWallParams(params: WallParams): WallValidationResult {
  const hardErrors: string[] = [];
  const codeViolations: string[] = [];

  validateGeometry(params, hardErrors);
...
function validateGeometry(params: WallParams, hardErrors: string[]): void {
