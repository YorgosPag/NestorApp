...
/**
 * Η έκταση του φύλλου, από **τρεις** πηγές που όλες επαληθεύτηκαν αληθείς — κρατιέται η
 * μέγιστη. Καμία μόνη της δεν αρκεί:
 * - οι γραμμές ξέρουν τα κελιά τους (**και** τα κελιά που έχουν μόνο στυλ),
