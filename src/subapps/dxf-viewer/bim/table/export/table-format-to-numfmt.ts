...
/**
 * Μια ημερομηνία-δείγμα με **ασύμμετρη** ημέρα και μήνα (5 Νοεμβρίου): αν ήταν π.χ. 3/3, η
 * σειρά ημέρας/μήνα θα ήταν αδιάκριτη και η ανίχνευση θα «δούλευε» χωρίς να μετρά τίποτα.
 */
