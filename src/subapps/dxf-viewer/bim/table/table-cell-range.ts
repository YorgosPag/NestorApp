 ...
 * μένει ακίνητο (Excel).
 *
 * 🔴 **Μηδέν νέα λογική πλοήγησης**: δανείζεται αυτούσιο το {@link moveTableCursor}, με
 * συνθετική θέση της οποίας η στήλη αγκύρωσης είναι ο εαυτός της. Έτσι ο κανόνας «άλλαξε ο
 * ιδιοκτήτης» — που λύνει τις συγχωνεύσεις — ισχύει αυτούσιος και για την επέκταση, χωρίς
 * να ξαναγραφτεί ούτε μία γραμμή. Ένα δεύτερο `stepOut` εδώ θα ήταν ακριβώς ο structural
 * clone που πιάνει το CHECK 3.28.
 *
