 ...
 *
 * Τρεις ρόλοι, και **κανένας τέταρτος** — γιατί κάθε ρόλος πρέπει να αντιστοιχεί σε ενέργεια
 * που **όντως** εκτελείται αν ο χρήστης πατήσει. Δες {@link tableIndicatorCursorRoleAtFrame}
 * για το γιατί λείπει το προφανές `'row-resize'`.
 */
export type TableIndicatorCursorRole = 'column-select' | 'row-select' | 'column-resize';
...
export function tableIndicatorCursorRoleAtFrame(
  ...
  if (!hit) return null;
  return hit.axis === 'column' ? 'column-select' : 'row-select';
}
