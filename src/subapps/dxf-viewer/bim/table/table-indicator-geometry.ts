...
// 🔴 ADR-739 §35 — η ζώνη του περιγράμματος ζει σε **δικό της** module: εδώ μένει η ερώτηση
 ...
 *
 * ## ⚠️ ΕΔΩ ΕΓΡΑΦΕ «τρεις ρόλοι, και ΚΑΝΕΝΑΣ ΤΕΤΑΡΤΟΣ». Η ΠΡΟΔΙΑΓΡΑΦΗ ΑΛΛΑΞΕ (§35)
 ...
 * χειρονομία που εκτελείται (§35), όχι εικονίδιο που παρηγορεί.
 *
...
export function tableIndicatorCursorRoleAtFrame(
  ...
  frame: TableFramePoint,
  bands: TableIndicatorBandsMm,
  // 🔴 §35 — το ορθογώνιο της **ενεργής επιλογής** σε sheet-mm· `null` = καμία επιλογή.
  //
  ...
  // 🔴 §35 — **ΑΠΟ ΕΔΩ ΚΑΙ ΚΑΤΩ ΕΙΜΑΣΤΕ ΜΕΣΑ ΣΤΟ ΠΛΕΓΜΑ, Ή ΠΟΥΘΕΝΑ.**
  //
  ...
  // 🔴 §35 — **ΕΔΩ ΕΠΕΣΤΡΕΦΕ `null`**, δηλαδή «μένει το σταυρόνημα του σχεδίου». Ο ιδιοκτήτης
