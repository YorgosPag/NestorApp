...
describe('🔴 §31 tableIndicatorCursorRoleAtFrame — ο δείκτης δεν επιτρέπεται να ΨΕΥΔΕΤΑΙ', () => {
  ...
  it('η άγκυρα και το δεξί πέρας ΔΕΝ είναι όρια στηλών — δεν έχουν λαβή, άρα ούτε υπόσχεση', () => {
    ...
    //
    // ⚠️ §35 — η αξίωση είναι «**δεν** υπόσχεται σύρσιμο πλάτους», όχι «δεν υπόσχεται τίποτα».
  ...
  it('🔴 §35 ΜΕΣΑ ΣΤΟ ΠΛΕΓΜΑ Ο ΔΕΙΚΤΗΣ ΕΙΝΑΙ ΣΤΑΥΡΟΣ ΚΕΛΙΟΥ — η προδιαγραφή ΑΝΤΙΣΤΡΑΦΗΚΕ', () => {
    ...
    //
    // Ο ιδιοκτήτης το άλλαξε (§35): «*στο Excel, μέσα σε κελί ο κέρσορας γίνεται σταυρός*».
  ...
  it('§35 το ΕΞΩ από το πλέγμα μένει ακέραιο — η γωνία και ο έξω χώρος δεν απέκτησαν ρόλο', () => {
