/**
 * 🔴 ADR-739 §36 — **η ζώνη του περιγράμματος**: πού τελειώνει το «μέσα στο κελί» και πού
...
describe('🔴 §36 signedDistanceToRectOutlineMm — αρνητική ΜΕΣΑ, μηδέν ΠΑΝΩ, θετική ΕΞΩ', () => {
...
describe('🔴 §36 isOnTableRangeBorder — η ζώνη διαστέλλεται ΕΚΑΤΕΡΩΘΕΝ της γραμμής', () => {
  const APERTURE = 2;
...
describe('🔴 §36 tableRangeDragIntentOf — ΔΥΟ ανεξάρτητες ερωτήσεις, όχι τέσσερις καταστάσεις', () => {
...
// ──────────────────────────────────────────────────────────────────────────────
// Η ένωση με τον δείκτη — §31 συνάντησε §36
// ──────────────────────────────────────────────────────────────────────────────

describe('🔴 §36 ο ρόλος δείκτη πάνω από επιλογή — Η ΣΕΙΡΑ ΠΡΟΤΕΡΑΙΟΤΗΤΑΣ', () => {
