...
function eurocodeColumnLimits(
  ...
  return {
    ...
    minRatio: 0.01,
    // EC2 §9.6.2 — τοίχωμα (mode==='wall'): ελάχιστο κατακόρυφο ποσοστό web επί gross
    // 0.002 (≠ column 1%). Ο validator το χρησιμοποιεί ώστε σωστά οπλισμένο τοιχίο
    // (boundary+web κατά EC8 §5.4.3.4.2) να ΜΗΝ σημαδεύεται ψευδώς ως ανεπαρκές.
    wallMinRatio: 0.002,
