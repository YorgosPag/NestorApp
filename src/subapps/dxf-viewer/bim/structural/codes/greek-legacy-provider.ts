...
function greekLegacyColumnLimits(
  ...
  return {
    ...
    minRatio: 0.01,
    // ΕΚΩΣ 2000 §18.4 — τοίχωμα (mode==='wall'): ελάχιστο κατακόρυφο ποσοστό
    // κατανεμημένου web 0.0025 (≠ column 1%). Ο validator το χρησιμοποιεί ώστε
    // σωστά οπλισμένο τοιχίο να ΜΗΝ σημαδεύεται ψευδώς ως ανεπαρκές.
    wallMinRatio: 0.0025,
