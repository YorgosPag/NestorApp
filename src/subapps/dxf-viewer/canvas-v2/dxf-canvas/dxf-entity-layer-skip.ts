...
export function isEntityLayerSkipped(
  ...
  // ADR-721 §8 — Layer-scope freeze. Τρίτο και τελευταίο scope, στη σειρά που ορίζει ο
  ...
  // του εγγράφου. Με το ADR-721 §2 (η σκηνή έγινε reactive) αυτό θα γινόταν ενεργά
