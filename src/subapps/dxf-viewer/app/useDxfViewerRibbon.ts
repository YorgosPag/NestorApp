...
export function useDxfViewerRibbon(params: DxfViewerRibbonParams): DxfViewerRibbonReturn {
  ...
  const { stairBridge, wallBridge, openingBridge, slabBridge, columnBridge, beamBridge, slabOpeningBridge, mepCircuitBridge, mepPipeNetworkBridge, mepFixtureBridge, furnitureBridge, floorplanSymbolBridge, mepFixtureLibraryBridge } =
  ...
  const ribbonCommands = useRibbonCommands({
    ...
    slabOpeningBridge, mepCircuitBridge, mepPipeNetworkBridge, mepFixtureBridge, furnitureBridge, floorplanSymbolBridge, mepFixtureLibraryBridge, lineToolBridge, xlineModeBridge,
  });
