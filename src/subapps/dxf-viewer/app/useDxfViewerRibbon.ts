...
export function useDxfViewerRibbon(params: DxfViewerRibbonParams): DxfViewerRibbonReturn {
  ...
  const { stairBridge, wallBridge, openingBridge, slabBridge, columnBridge, beamBridge, slabOpeningBridge, mepCircuitBridge, mepFixtureBridge } =
  ...
  const ribbonCommands = useRibbonCommands({
    ...
    slabOpeningBridge, mepCircuitBridge, mepFixtureBridge, lineToolBridge, xlineModeBridge,
  });
