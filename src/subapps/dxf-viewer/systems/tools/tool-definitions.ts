...
export const TOOL_DEFINITIONS: Record<ToolType, ToolInfo> = {
  ...
  'column-in-region': { id: 'column-in-region', category: 'drawing', requiresCanvas: true, canInterrupt: true, allowsContinuous: true, preservesOverlayMode: false }, // ADR-419 «Κολώνα σε περιοχή» — 4 lines / click inside / box-select → ColumnEntity ανά ορθογώνιο (ΙΔΙΑ SSoT με wall-in-region)
