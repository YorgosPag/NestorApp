...
/**
 * ADR-739 §31/§35 — ρόλος λειτουργίας πίνακα → τιμή CSS `cursor`. Η **μία** μετάφραση.
 *
 * Τέσσερις από τους έξι ρόλους είναι λέξεις-κλειδιά που ζωγραφίζει ο **ΟΣ** (μηδέν ράστερ,
 * μηδέν κόστος, και ο χρήστης βλέπει το δικό του θέμα δείκτη)· οι δύο βελών επιλογής δεν
 * έχουν λέξη-κλειδί σε καμία πλατφόρμα και ζωγραφίζονται. Η επιλογή «native όπου υπάρχει» δεν
 ...
 *
 * ## 🔴 §35 — ΤΟ `cell` ΕΙΝΑΙ ΚΥΡΙΟΛΕΚΤΙΚΑ Ο ΣΤΑΥΡΟΣ ΠΟΥ ΖΗΤΗΘΗΚΕ, ΚΑΙ ΕΙΝΑΙ ΔΩΡΕΑΝ
