 ...
 * καμία πλατφόρμα, και ο σταυρός της λαβής συμπλήρωσης (ADR-754 §15) επειδή η λέξη-κλειδί
...
function tableIndicatorCursorValue(role: TableIndicatorCursorRole): string {
  switch (role) {
    ...
    case 'delete-control':
      return 'pointer';
    // 🔴 ADR-754 §15 — **ο λεπτός μαύρος σταυρός της λαβής συμπλήρωσης** (Excel parity).
    //
