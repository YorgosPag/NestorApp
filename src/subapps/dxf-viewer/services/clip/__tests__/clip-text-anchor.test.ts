/**
 * ADR-753 §21 — χαρακτηρισμός: **η αγκύρωση καθορίζει ποιοι χαρακτήρες επιβιώνουν της αποκοπής.**
 *
 ...
 * το `services/clip` **έμεινε πράσινο, γιατί δεν είχε ΚΑΝΕΝΑ test**. Το handoff έγραφε
