 ...
 */
export function CanvasLayerStack2DOverlays({ viewport }: CanvasLayerStack2DOverlaysProps) {
  return (
    <>
      <AutoAreaPreviewOverlay viewport={viewport} />
      <RegionPerimeterPreviewOverlay viewport={viewport} />
      ...
      <RegionGapMarkersOverlay viewport={viewport} />
      ...
      <BasePointPickMarkerOverlay viewport={viewport} />
