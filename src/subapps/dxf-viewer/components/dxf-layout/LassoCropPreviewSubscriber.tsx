 ...
 * Subscribes to PolygonCropStore + ImmediateSnapStore.
 * Only this component re-renders on polygon point add / snap change.
...
const _getPolygonPoints = () => PolygonCropStore.getPoints();
const _subscribePolygon = (cb: () => void) => PolygonCropStore.subscribe(cb);

/**
 * Renders the in-progress polygon-crop as an SVG overlay.
...
/** @deprecated Use PolygonCropPreviewSubscriber */
export { PolygonCropPreviewSubscriber as LassoCropPreviewSubscriber };
