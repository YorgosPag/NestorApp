...
export const CanvasSection: React.FC<DXFViewerLayoutProps & { overlayMode: OverlayEditorMode, currentStatus: Status, currentKind: OverlayKind }> = (props) => {
  ...
  const { circleTTT, lineParallel, angleEntityMeasurement, stairTool, stairRegionTool, wallTool, slabTool, roofTool, floorFinishTool, wallCoveringTool, columnTool, foundationTool, mepFixtureTool, furnitureTool, blockLibraryTool, floorplanSymbolTool, electricalPanelTool, mepManifoldTool, mepRadiatorTool, mepBoilerTool, mepWaterHeaterTool, mepUnderfloorTool, thermalSpaceTool, bathroomAutoArrangeTool, spaceSeparatorTool, mepSegmentTool, mepRiserTool, railingTool, beamTool, beamBetweenMembersTool, slabOpeningTool, openingTool, selfOpeningTool } = useSpecialTools({ activeTool, levelManager });
  ...
  const { handleCanvasClick } = useCanvasClickHandler({
    ...
    foundationTool,
    mepFixtureTool,
    furnitureTool, blockLibraryTool,
    floorplanSymbolTool,
    electricalPanelTool,
    mepManifoldTool,
    mepRadiatorTool,
