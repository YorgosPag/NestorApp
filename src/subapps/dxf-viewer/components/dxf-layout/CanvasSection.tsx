...
export const CanvasSection: React.FC<DXFViewerLayoutProps & { overlayMode: OverlayEditorMode, currentStatus: Status, currentKind: OverlayKind }> = (props) => {
  ...
  const { handleCanvasClick } = useCanvasClickHandler({
    ...
    foundationTool,
    mepFixtureTool,
    furnitureTool, blockLibraryTool, titleBlockTool, furniturePlanTool, peoplePlanTool, vehiclesPlanTool,
    floorplanSymbolTool,
    electricalPanelTool,
    mepManifoldTool,
    mepRadiatorTool,
