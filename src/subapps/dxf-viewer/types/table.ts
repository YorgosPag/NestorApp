 ...
 * χωρίς προειδοποίηση. Πέντε γενικοί μηχανισμοί της εφαρμογής περνούν κάθε οντότητα από
 * JSON round-trip (αποθήκευση σκηνής, `deepClone` για undo, διαγραφή+αναίρεση,
 * πρόχειρο, λανθάνουσα μνήμη ζωγραφικής) — άρα ένας πίνακας με `Map` έχανε **όλα** τα
 * κελιά του σε καθέναν από αυτούς, δείχνοντας άδειο πλέγμα μετά από reload ή undo.
 *
