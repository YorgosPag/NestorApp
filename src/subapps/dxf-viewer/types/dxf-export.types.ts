...
export const ENTITY_TYPE_MAPPING: Record<EntityType, EzdxfEntityType | null> = {
  ...
  'opening-info-tag': null, // ADR-612 — opening info tag annotation — exported via composite
  table: null,             // ADR-739 Φ.Γ — γενικός πίνακας — αποδομείται (native ACAD_TABLE = Φ.Ε)
  ...
  'generic-solid': null,   // ADR-684 παραμετρικό στερεό — composite (footprint outline)
