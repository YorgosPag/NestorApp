...
export const TABLE_BOUND_STATE = {
  ...
  /** Το τριγωνάκι της **παράκαμψης** — ανθρώπινη απόφαση, όχι σφάλμα. */
  overriddenHex: UI_COLORS.WARNING,
  /** Το τριγωνάκι της **σύγκρουσης** — η μόνη κατάσταση που απαιτεί απόφαση. */
  conflictHex: UI_COLORS.ERROR,
  /**
   * Η κάθετη πλευρά του τριγώνου στη γωνία του κελιού, σε **px οθόνης**.
   *
   * Θέση: **πάνω-αριστερά**, η θέση του δείκτη σφάλματος του Excel/Sheets — και η μόνη γωνία
   * κελιού που δεν διεκδικείται ήδη (η λαβή συμπλήρωσης κάθεται κάτω-δεξιά, §Γ4).
   */
  markSizePx: 6,
  /**
