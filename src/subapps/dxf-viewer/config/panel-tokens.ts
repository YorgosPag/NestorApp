...
export const PANEL_LAYOUT = {
  ...
  Z_INDEX: {
    ...
    // 55 - ΠΑΝΩ από το `BimViewport3D` (z-50, absolute inset-0): HUD επιπέδου καμβά που οφείλει
    // να φαίνεται ΚΑΙ στις δύο προβολές (Performance HUD, απόδοση υποβάθρου χάρτη). Κάτω από το
    // κατώφλι 1000 της κλίμακας ADR-780, άρα σκόπιμα `local-stacking` και όχι ρόλος: ταξινομεί
    // αδέρφια μέσα στον καμβά, δεν δηλώνει καθολική στρώση προϊόντος.
    '55': 'z-[55]',
  },
