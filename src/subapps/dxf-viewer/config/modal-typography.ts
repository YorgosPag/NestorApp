...
/**
 * Modal-specific typography hierarchy based on existing design tokens
...
/**
 * Typography specifically for DXF viewer modals
 * Optimized for technical interfaces and CAD workflows
 */
export const DXF_MODAL_TYPOGRAPHY = {
  // Technical titles with monospace feeling
  TITLE: {
    default: `text-lg font-semibold text-white leading-tight tracking-wide`,    // 18px, white, wide letter spacing
    emphasized: `text-xl font-bold text-orange-400 leading-tight tracking-wide`, // 20px, orange accent
  },

  // Technical labels
  LABEL: {
    default: `text-sm font-medium text-gray-300 leading-normal`,                // 14px, gray-300
    required: `text-sm font-medium text-gray-300 leading-normal`,               // + red asterisk
    technical: `text-xs font-medium text-gray-400 uppercase tracking-wider`,   // 12px, uppercase, wide tracking
  },

  // Technical descriptions
  DESCRIPTION: {
    default: `text-xs text-gray-400 leading-normal`,                           // 12px, gray-400
    error: `text-xs text-red-400 leading-normal`,                              // 12px, red-400
    success: `text-xs text-green-400 leading-normal`,                          // 12px, green-400
    warning: `text-xs text-orange-400 leading-normal`,                         // 12px, orange-400
    technical: `text-xs text-gray-500 font-mono leading-normal`,               // 12px, monospace font
  },

  // Technical buttons
  BUTTON: {
    primary: `text-sm font-medium text-white`,                                 // 14px, white
    secondary: `text-sm font-medium text-gray-300`,                           // 14px, gray-300
    outline: `text-sm font-medium text-gray-300 hover:text-white`,           // 14px, hover effect
  },
} as const;
 ...
 */
export const RESPONSIVE_MODAL_TYPOGRAPHY = {
  // Responsive titles
  TITLE: {
 ...
 */
export const MODAL_CONTENT_HIERARCHY = {
  // H1 - Main modal title
  h1: MODAL_TYPOGRAPHY.TITLE.default,

  // H2 - Section headers within modal
  h2: `text-base font-semibold text-foreground leading-normal mb-3`,

  // H3 - Subsection headers
  h3: `text-sm font-semibold text-foreground leading-normal mb-2`,

  // H4 - Field group headers
  h4: `text-sm font-medium text-muted-foreground leading-normal mb-2`,

  // Paragraph text
  p: MODAL_TYPOGRAPHY.BODY.default,

  // Small text
  small: MODAL_TYPOGRAPHY.DESCRIPTION.default,
 ...
 */
export const A11Y_MODAL_TYPOGRAPHY = {
  // High contrast text combinations
  HIGH_CONTRAST: {
    title: `text-xl font-bold text-gray-900 dark:text-white`,
    body: `text-base text-gray-800 dark:text-gray-100`,
...
export type ModalTypographyElement = keyof typeof MODAL_TYPOGRAPHY;
export type DxfModalTypographyElement = keyof typeof DXF_MODAL_TYPOGRAPHY;
export type ModalContentElement = keyof typeof MODAL_CONTENT_HIERARCHY;
