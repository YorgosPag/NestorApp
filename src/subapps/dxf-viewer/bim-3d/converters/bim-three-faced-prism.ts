 ...
 * Slab-openings/holes = Φ2. Κάθε όψη παίρνει box-projected world-meter UVs (ΕΝΑ set) ώστε
...
export function buildFacedPrism(
  ...
  // Box-projected world-meter UVs (ΕΝΑ set) ανά όψη, βάσει των flat normals μόλις
