 ...
 *
 * ✅ **Η ευρύτερη ρίζα διορθώθηκε στο ADR-780 Φάση Δ**: το `component-sizes.ts` έδινε σε κάθε
 * dropdown της εφαρμογής ωμό `z-50` (ADR-724 §14.9.3). Πλέον όλη η παροδική οικογένεια ζητά ΕΝΑ
 * σκαλί της κλίμακας (`transientStack`), πάνω από την πλωτή παλέτα (`workspaceSidePanel`). Το
 * `popover` εδώ μένει: είναι ψηλότερα και από εκείνο, άρα δεν αλλάζει τίποτα ορατό.
 *
