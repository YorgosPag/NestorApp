...
Το OCR μερικές φορές παραμορφώνει ελληνικά τεχνικά ονόματα. Εφόσον το συγκείμενο υποδεικνύει κατασκευαστικό/αλουμινοκατασκευαστικό προϊόν, διόρθωσε αυτόματα:
- "ΓΙΑΝΤΖΟΥΡΗ", "ΙΑΝΤΖΟΥΡΗ", "ΑΤΖΟΥΡΗ", "ΑΝΤΖΟΥΡΗ", "ΓΙΑΝΤΖΟΎΡΗ" → ΠΑΝΤΖΟΥΡΙ (εξωτερικό ρολό/κλείσιμο παραθύρου/πόρτας)
- "ΡΟΛΟ ΕΞΩΤΕΡΙΚΟ", "ΡΟΛΌ ΕΞΩΤΕΡΙΚΌ" = σωστά (μην αλλάζεις)
- "ΚΟΥΦΩΜΑ", "ΚΟΥΦΩΜΑΤΑ" = σωστά (μην αλλάζεις)
