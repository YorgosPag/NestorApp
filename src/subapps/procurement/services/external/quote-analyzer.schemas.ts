...
- vendorVat: ΑΦΜ προμηθευτή. ΚΡΙΣΙΜΟΣ ΚΑΝΟΝΑΣ — ΠΟΤΕ μην μπερδεύεις ΑΦΜ με IBAN:
  • ΑΦΜ = ΑΠΟΚΛΕΙΣΤΙΚΑ 9 ψηφία (π.χ. "123456789"). Μόνο αριθμοί, χωρίς γράμματα.
  • IBAN = ξεκινά με "GR" + 26 ψηφία = 28 χαρακτήρες (π.χ. "GR1601101250000000012300695"). Είναι τραπεζικός αριθμός λογαριασμού.
  • Αν ο αριθμός που βρίσκεις ξεκινά με "GR" ή έχει περισσότερους από 9 χαρακτήρες → είναι IBAN, ΟΧΙ ΑΦΜ → βάλε null + confidence: 0.
  • Αν δεν υπάρχει σαφής 9-ψήφιος αριθμός ΑΦΜ → null + confidence: 0. ΜΗΝ μαντεύεις.
...
**ΟΡΟΙ:**
- paymentTerms: Όροι πληρωμής (π.χ. "30 ημέρες", "προκαταβολή 30%"). Αν το πεδίο "Τρόπος Πληρωμής/Payment Options" είναι κενό → null + confidence 0.
...
- notes: Λοιπές παρατηρήσεις. ΣΥΛΛΕΞΕ από ΟΛΕΣ τις σελίδες: όρους ισχύος ("ισχύει για X ημέρες"), δικαιοδοσία, προειδοποιήσεις αλλαγών μέτρων, μεταφορά. Συγχώνευσέ τα σε ΕΝΑ συμπυκνωμένο string.
