...
- notes: Λοιπές παρατηρήσεις. ΣΥΛΛΕΞΕ από ΟΛΕΣ τις σελίδες: όρους ισχύος, δικαιοδοσία, προειδοποιήσεις, μεταφορά. ΥΠΟΧΡΕΩΤΙΚΟ: γράψε ΠΑΝΤΟΤΕ ΚΑΙ ΣΤΑ ΔΥΟ — Ελληνικά ΚΑΙ Αγγλικά. Μορφή: "[GR] <ελληνικό κείμενο>\n[EN] <english text>". Αν το έγγραφο είναι σε άλλη γλώσσα, μετάφρασε και τα δύο. Null μόνο αν δεν υπάρχει ΤΙΠΟΤΑ.
