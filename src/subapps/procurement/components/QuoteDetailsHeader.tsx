...
function ExpiryBanner({ validUntilDate, daysAgo, onRequestRenewal, t }: {
  ...
  return (
    <div className="mx-2 mb-2 px-3 py-2 rounded-md bg-[hsl(var(--bg-warning))]/40 border border-[hsl(var(--text-warning))]/60 flex items-center justify-between gap-3 text-sm">
      ...
      {onRequestRenewal && (
        <Button size="sm" variant="outline" onClick={onRequestRenewal} className="shrink-0 text-foreground border-[hsl(var(--text-warning))]/60 hover:bg-[hsl(var(--bg-warning))]/90">
