  ...
  return (
    <div
      ...
      className={cn(
        ...
        state === 'offline'
          ? 'bg-[hsl(var(--bg-warning))]/40 text-foreground border border-[hsl(var(--text-warning))]/60'
          : 'bg-[hsl(var(--bg-success))]/40 text-[hsl(var(--text-success))] border border-[hsl(var(--text-success))]/60',
      )}
    >
      {state === 'offline' ? (
        <>
