...
export function ComparisonWinnerBanner({
  ...
  return (
    <div className="flex items-center justify-between rounded-lg border border-[hsl(var(--text-success))]/40 bg-[hsl(var(--bg-success))]/40 px-4 py-3">
      <div className="flex items-center gap-3">
        <CheckCircle2 className="h-5 w-5 shrink-0 text-[hsl(var(--text-success))]" />
        <div>
