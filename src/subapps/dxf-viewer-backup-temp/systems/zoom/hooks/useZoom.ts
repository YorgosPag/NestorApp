...
interface UseZoomReturn {
  ...
  // Wheel zoom
  handleWheelZoom: (wheelDelta: number, center: { x: number; y: number }, constraints?: ZoomConstraints) => void;
...
export const useZoom = ({
  ...
  const handleWheelZoom = useCallback((
    ...
    const result = zoomManager.wheelZoom(wheelDelta, center, constraints);
    handleZoomResult(result);
  }, [zoomManager, handleZoomResult]);
