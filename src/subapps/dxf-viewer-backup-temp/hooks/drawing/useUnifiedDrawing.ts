...
export function useUnifiedDrawing() {
  ...
  }, [state, createEntityFromTool, currentLevelId, setMode]); // ✅ FIX: Removed getLevelScene and setLevelScene from deps to prevent infinite loop
  ...
  const finishPolyline = useCallback(() => {
    ...
    return null;
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [state, createEntityFromTool, currentLevelId, cancelDrawing, setMode]); // ✅ FIX: Removed getLevelScene and setLevelScene from deps to prevent infinite loop
