...
export function useSceneState() {
  ...
  }, [currentLevelId]); // ✅ FIX: Removed getLevelScene from deps to prevent infinite loop (accessed via closure)
  ...
  useEffect(() => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [currentLevelId]); // ✅ FIX: Removed getLevelScene and setLevelScene from deps to prevent infinite loop
