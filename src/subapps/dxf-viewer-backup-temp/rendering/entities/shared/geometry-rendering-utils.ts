...
// ✅ ΔΙΟΡΑΘΩΣΗ ΔΙΠΛΟΤΥΠΟΥ: calculateDistance αφαιρέθηκε - χρήση pointDistance από ./geometry-utils.ts
// Όλα τα imports πρέπει να χρησιμοποιούν: import { pointDistance } from './geometry-utils';
