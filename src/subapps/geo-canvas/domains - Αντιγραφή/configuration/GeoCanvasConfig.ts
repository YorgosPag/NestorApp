 ...
 */
const DEFAULT_TOOL_CONFIGS: ToolConfiguration[] = [
  {
    id: 'select',
    type: 'select',
    name: 'Select',
 ...
 */
const DEFAULT_PANEL_CONFIGS: PanelConfiguration[] = [
  {
    id: 'coordinates',
    type: 'coordinates',
    title: 'Coordinates',
 ...
 */
const DEFAULT_LAYER_CONFIGS: LayerConfiguration[] = [
  {
    id: 'base-map',
    type: 'base-map',
    name: 'Base Map',
 ...
 */
const DEFAULT_MEASUREMENT_CONFIG: MeasurementConfiguration = {
  units: {
    distance: 'meters',
    area: 'square-meters',
    angle: 'degrees'
