...
export interface SoleProprietorProfile extends CompanyProfileBase {
  ...
  /**
   * Αριθμός ΓΕΜΗ — **`null` για ελεύθερο επαγγελματία** (μηχανικός, δικηγόρος) που δεν εγγράφεται.
   *
   * 🔴 ADR-841 §7 Α23: ως τις 2026-09-14 το πεδίο **δεν υπήρχε** στην ατομική (ADR-ACC-012:
   * «αδύνατο σε ατομική») — νομικά λάθος: ατομική με **εμπορική** δραστηριότητα εγγράφεται στο
   * ΓΕΜΗ (ν. 4919/2022 άρθ. 16) και οφείλει να δείχνει τον αριθμό (άρθ. 22).
   */
