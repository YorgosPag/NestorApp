  ...
  return (
    <TableRow>
      ...
      <TableCell className="text-center">
        {record.status === 'sent' ? (
          <Badge className="bg-[hsl(var(--bg-success))]/40 text-green-707 border-[hsl(var(--bg-success))] text-xs">
        ...
        <div className="flex items-center gap-2 shrink-0">
          {!cert.isReceived && (
            <Button
              ...
              className="text-green-707 border-[hsl(var(--bg-success))] hover:bg-[hsl(var(--bg-success))]/10"
            >
              {markingReceived ? (
