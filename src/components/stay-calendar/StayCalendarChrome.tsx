  ...
  return (
    <section aria-label={t('property-market:offer.stayCalendar.legend.title')}>
      <ul className="flex flex-wrap gap-x-4 gap-y-1 text-xs text-muted-foreground">
        ...
        <li className="flex items-center gap-1.5"><span aria-hidden className={cn(swatch, 'border-dashed border-foreground/40 bg-card')}><UserRound className="size-3" /></span>{t('property-market:offer.stayCalendar.legend.requested')}</li>
