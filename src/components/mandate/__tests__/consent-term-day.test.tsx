 ...
 *
 * ⏸️ **ΔΗΛΩΜΕΝΟ ΟΡΙΟ, ΡΗΤΑ**: αυτό εκτελεί το **component**, όχι τη διαδρομή
 * `/mandate/[token]` — εκείνη απαιτεί **ζωντανό token συγκατάθεσης**, και το μοναδικό
 * της βάσης έχει `consentNonce: null` *(καταναλώθηκε στις 30/08)*. Δες ADR-834 §6.5.α.
 */
