    ...
    <ShellSurface as="main" measure="prose" className="gap-6">
      ...
      */}
      ...
      {/*
        ...
        `profile.companyId` — την **ταυτότητα του ίδιου εγγράφου** που μόλις διαβάστηκε,
        ποτέ το prop *(που μπορεί να είναι `null`)*. Εδώ φτάνει **η απάντηση**: η
        ενότητα δεν ξαναρωτά, γιατί η ίδια απάντηση κρίνεται **και** στη γραμμή της
        εμβέλειας παραπάνω *(Φ5γ)*.
      */}
