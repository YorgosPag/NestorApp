/**
 * =============================================================================
 * AddUnitDialog — State Hook
 * =============================================================================
 *
 * All state, effects, and constants for the AddUnitDialog.
 *
 * @module components/units/dialogs/useAddUnitDialogState
 * @enterprise ADR-034
 */
...
export function useAddUnitDialogState({
  open,
  onUnitAdded,
  onOpenChange,
}: Pick<AddUnitDialogProps, 'open' | 'onUnitAdded' | 'onOpenChange'>) {
  // Form state management
  const form = useUnitForm({ onUnitAdded, onOpenChange });
