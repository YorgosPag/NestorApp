...
export const TRANSITION_PRESETS = {
  ...
  FAST_ALL: `${TRANSITION_PROPERTIES.ALL} ${TRANSITION_DURATIONS.FAST} ${TRANSITION_EASING.EASE_OUT}`,
...
export const CONTEXT_TRANSITIONS = {
  ...
  BUTTON: {
    ...
    SECONDARY: TRANSITION_PRESETS.STANDARD_COLORS,
  ...
  FORM: {
    ...
    SUBMIT_BUTTON: TRANSITION_PRESETS.STANDARD_COLORS
  },
