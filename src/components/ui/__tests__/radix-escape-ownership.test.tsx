 ...
 *
 * 📌 ADR-364 §10.15.γ (2026-09-11): η κλήση του bus (`noteBusDispatch`) είναι και η απόδειξη ότι ο bus
 * **άκουγε** — γι' αυτό η προσομοίωση δεν χρειάζεται να «οπλίσει» τίποτα και η κρίση δεν βγαίνει `unarmed`.
 *
