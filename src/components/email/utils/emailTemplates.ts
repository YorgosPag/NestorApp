...
export const emailTemplates = (_fullName?: string) => ([
  ...
  { id: "proposal",   name: "email.templates.proposal.name",    icon: NAVIGATION_ENTITIES.property.icon, description: "email.templates.proposal.description", defaultSubject: "email.templates.proposal.subject" },
...
export const getTemplateContent = (templateId: string, _fullName?: string) => {
