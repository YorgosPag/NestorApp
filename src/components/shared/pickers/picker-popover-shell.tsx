...
/**
 * ============================================================================
 * Picker Popover Shell (SSoT — ADR-601, promoted from ADR-325)
 * ============================================================================
 *
 * SSoT wrapper for search-first autocomplete picker popovers
 * (EmployerPicker, EscoOccupationPicker, EscoSkillPicker).
 *
 ...
 *
 * History: originally `esco/esco-picker-popover-shell.tsx` (ADR-325); promoted
 * to `shared/pickers/` in ADR-601 when EmployerPicker joined the family (it had
 * still been using the buggy `<PopoverTrigger>` path). The old path re-exports
 * this module for backward compatibility.
 *
 * @module components/shared/pickers/picker-popover-shell
 */

import * as React from 'react';
import { Popover, PopoverAnchor, PopoverContent } from '@/components/ui/popover';

export interface PickerPopoverShellProps {
   ...
   * the focus-within ring, so every picker shows an identical visual focus cue
   * regardless of which descendant actually receives focus.
   */
...
export default PickerPopoverShell;
