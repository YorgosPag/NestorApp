...
const ACTION_COLOR_MAP: Record<string, string> = {
  view: 'text-primary',
  download: 'text-[hsl(var(--text-success))]',
  upload: 'text-primary',
  finalize: 'text-primary',
  rename: 'text-[hsl(var(--text-warning))]',
  description_update: 'text-[hsl(var(--text-warning))]',
  classify: 'text-primary',
  ai_classify: 'text-primary',
  delete: 'text-destructive',
  restore: 'text-[hsl(var(--text-success))]',
  archive: 'text-[hsl(var(--text-warning))]',
  version_create: 'text-primary',
  version_rollback: 'text-[hsl(var(--text-warning))]',
  link: 'text-primary',
  unlink: 'text-[hsl(var(--text-warning))]',
  batch_delete: 'text-destructive',
  batch_download: 'text-[hsl(var(--text-success))]',
  batch_classify: 'text-primary',
  share: 'text-primary',
  share_revoke: 'text-destructive',
