          ...
          <CardContent className="pt-2 flex justify-center">
            <div className="flex gap-x-2" ref={formRef}>
                ...
                <div className="space-y-2">
                    ...
                    <FormField label={t('projects.buildingData.fields.maxVolumeCoefficient')} id="maxVolumeCoefficient" value={allowedDataInput.maxVolumeCoefficient} unit="" labelClassName="text-green-707" onChange={handleChange} onEnterPress={handleEnterNavigation} labelPosition='left' inputClassName="w-40" readOnly={!isEditing} />
