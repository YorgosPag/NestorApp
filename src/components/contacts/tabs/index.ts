/**
 * 🏢 ENTERPRISE: Contact Tabs Components
 *
 * Centralized exports για όλα τα contact tab components.
 * Part of the UniversalTabsRenderer migration από legacy systems.
 */

export { ContactBasicInfoTab } from './ContactBasicInfoTab';
...
export type { ContactBasicInfoTab as ContactBasicInfoTabType } from './ContactBasicInfoTab';
