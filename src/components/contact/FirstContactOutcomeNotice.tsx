 ...
 *
 * 🔑 **ΕΞΑΓΕΤΑΙ ΓΙΑ ΤΟΝ ΙΔΙΟ ΛΟΓΟ ΜΕ ΤΟ {@link RefusedBody}** *(ADR-844 Β5)*: το ίδιο
 * ερώτημα ρωτιέται σε **δύο** τόπους — εδώ, μέσα στον διάλογο, και στη σελίδα του
 * συνδέσμου (`GuestContactContent`), όπου ο άνθρωπος φτάνει **από email**. Δεύτερο
 * αντίγραφο θα ξεχνούσε το **έκτο** αμετάβλητο στο ένα από τα δύο σημεία — ακριβώς το
 * περιστατικό `listing-conflicting-mandate` του γειτονικού υποσυστήματος.
 *
 * ⚠️ **Ο ξενιστής δίνει το δοχείο**, όπως και στον αδελφό του: εδώ τυλίγεται σε
 * `role="alert"` γιατί **μόλις έγινε πράξη**· στη σελίδα **όχι**, γιατί ο άνθρωπος
 * απλώς άνοιξε μια διεύθυνση και ο τίτλος της σελίδας το λέει ήδη.
 */
