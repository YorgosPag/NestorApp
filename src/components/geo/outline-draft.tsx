 ...
 * - *«πού ψάχνεις;»* → **Ζ4**, σχεδιασμένη περιοχή αναζήτησης — ✅ **ADR-885**: ο τρόπος «πάτημα
 *   κορυφής» της `useDrawAreaSession`, δίπλα στην ελεύθερη χειρονομία (`lib/geo/geo-freehand.ts`)
 *
