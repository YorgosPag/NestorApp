...
export function GlobalFileUploadToast() {
  ...
  useEffect(() => {
    ...
    // 🔇 ADR-845 Ο-16 · ADR-862 Φ0 Β10 — ΑΝΤΙΚΑΤΑΣΤΑΣΗ ≠ ΔΙΑΓΡΑΦΗ. Η αντικατάσταση είναι πλέον
    // `FILE_SUPERSEDED` και **δεν** ακούγεται εδώ: ο διάδοχος έχει ήδη ανακοινωθεί από το
    // `fileReady`, και ένα δεύτερο «στον κάδο» για το ίδιο συμβάν θα έλεγε ψέματα.
