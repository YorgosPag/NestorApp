...
/**
 * @fileoverview **ΤΟ ΠΑΝΕΛ «ΠΕΡΙΗΓΗΣΗ 360°» ΤΗΣ ΚΑΡΤΕΛΑΣ ΑΓΓΕΛΙΑΣ** — φωτογράφοι + εισερχόμενα λήψεων.
 ...
 * ⚠️ Ο θεατής και ο συντάκτης γράφου (τοποθέτηση στην κάτοψη) είναι Φ1/Φ2 — εδώ ζει μόνο η ροή λήψης.
 */
...
export function SpatialTourPanel({ subject }: { readonly subject: TourSubject }) {
