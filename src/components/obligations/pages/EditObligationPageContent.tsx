...
/**
 * Edit Obligation Page Content
 *
 * @module components/obligations/pages/EditObligationPageContent
 * @enterprise ADR-294 Batch 8 — extracted from app/obligations/[id]/edit/page.tsx
 */
...
export function EditObligationPageContent() {
