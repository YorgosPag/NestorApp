...
/**
 * =============================================================================
 * OBLIGATIONS HUB PAGE CONTENT - OBLIGATIONS REGISTER
 * =============================================================================
 *
 * Enterprise Pattern: List view with search and status filter
 * Features: Obligations table, search, status filter, create link
 *
 * @module components/obligations/pages/ObligationsHubPageContent
...
export function ObligationsHubPageContent() {
...
export default ObligationsHubPageContent;
