      ...
      <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            <label className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className={cn("text-xs", colors.text.muted)}>{t('exportOptions.content.toc.description')}</p>
              </div>
            </label>
            <label className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className={cn("text-xs", colors.text.muted)}>{t('exportOptions.content.pageNumbers.description')}</p>
              </div>
            </label>
            <label className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className={cn("text-xs", colors.text.muted)}>{t('exportOptions.content.logo.description')}</p>
              </div>
            </label>
          </div>
        </div>
            ...
            <div className="space-y-2">
                <label className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className={cn("text-xs", colors.text.muted)}>{t('exportOptions.quality.standard.description')}</p>
                    </div>
                </label>
                <label className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className={cn("text-xs", colors.text.muted)}>{t('exportOptions.quality.high.description')}</p>
                    </div>
                </label>
            </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div className="space-y-2">
              <div className="flex justify-between"><span className={colors.text.muted}>{t('exportOptions.preview.sections')}</span><Badge variant="outline">{contentSummary.sections}</Badge></div>
              <div className="flex justify-between"><span className={colors.text.muted}>{t('exportOptions.preview.articles')}</span><Badge variant="outline">{contentSummary.articles}</Badge></div>
              <div className="flex justify-between"><span className={colors.text.muted}>{t('exportOptions.preview.paragraphs')}</span><Badge variant="outline">{contentSummary.paragraphs}</Badge></div>
            </div>
            <div className="space-y-2">
              <div className="flex justify-between"><span className={colors.text.muted}>{t('exportOptions.preview.words')}</span><Badge variant="outline">{contentSummary.words.toLocaleString()}</Badge></div>
              <div className="flex justify-between"><span className={colors.text.muted}>{t('exportOptions.preview.readingTime')}</span><Badge variant="outline">{contentSummary.readingTime} {t('exportOptions.preview.minutes')}</Badge></div>
              <div className="flex justify-between"><span className={colors.text.muted}>{t('exportOptions.preview.estimatedPages')}</span><Badge variant="outline">~{Math.ceil(contentSummary.words / 300)}</Badge></div>
            </div>
          </div>
        </div>
      </CardContent>
