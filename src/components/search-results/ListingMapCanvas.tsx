...
export function ListingMapCanvas({
  ...
  return (
     ...
     *
     * ✅ Το «σχεδίασε την περιοχή σου» της Α4 §27.4 έγινε (**ADR-885**) — **χωρίς** αυτό το
     * σύστημα πολυγώνων: μπαίνει ως `children` του χάρτη (`draw/SearchAreaMapLayer`), γιατί το
     * SPEC-777A §13.7 κρατά το `components/geo/` χωρίς επαφή με το Geo-Canvas (ADR-782).
     */
