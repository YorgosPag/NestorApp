...
describe('Θ2 ✅ Η ΑΠΟΦΑΣΗ, ΠΑΝΩ ΣΤΟΝ ΠΡΑΓΜΑΤΙΚΟ HOOK', () => {
  it('Θ2α 🔴 — ο τίτλος βγαίνει από το ΚΛΕΙΔΙ και ΟΝΟΜΑΖΕΙ το ακίνητο', () => {
    ...
    // ⚠️ ADR-857 — ο έλεγχος στρέφεται στο **σημερινό** όνομα: το «ΝΕΣΤΩΡ» δεν παράγεται πια
    //    από πουθενά, άρα ως φρουρός θα ήταν **νεκρός** (απαίτηση για κάτι αδύνατο).
    expect(out).not.toContain('Nestor App');
  });
