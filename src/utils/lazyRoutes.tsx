...
export const PageLoadingSpinner = () => (
  <main className="min-h-screen bg-background flex items-center justify-center" role="status" aria-label="Φόρτωση σελίδας">
    <section className="text-center">
      <div className="animate-spin rounded-full h-16 w-16 border-b-2 border-primary mx-auto mb-6" aria-hidden="true"></div>
      ...
      <section className="p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="space-y-2">
            <div className="h-8 bg-muted rounded w-48 animate-pulse" aria-hidden="true"></div>
            <div className="h-4 bg-muted rounded w-64 animate-pulse" aria-hidden="true"></div>
          </div>
          <div className="flex space-x-3">
            <div className="h-10 w-32 bg-muted rounded animate-pulse" aria-hidden="true"></div>
            <div className="h-10 w-10 bg-muted rounded animate-pulse" aria-hidden="true"></div>
          </div>
        </div>
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4" aria-label="Φόρτωση στατιστικών">
          {Array.from({ length: 4 }).map((_, i) => (
            <article key={i} className="bg-background border rounded-lg p-4">
              <div className="space-y-2">
                <div className="h-4 bg-muted rounded w-16 animate-pulse" aria-hidden="true"></div>
                <div className="h-8 bg-muted rounded w-20 animate-pulse" aria-hidden="true"></div>
                <div className="h-3 bg-muted rounded w-24 animate-pulse" aria-hidden="true"></div>
              </div>
            </article>
          ))}
        </section>
    ...
    <section className="max-w-4xl mx-auto">
      <form className="bg-card border rounded-lg p-6">
        <fieldset className="space-y-6">
          <div className="h-6 bg-muted rounded w-48 animate-pulse" aria-hidden="true"></div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {Array.from({ length: 6 }).map((_, i) => (
              <div key={i} className="space-y-2">
                <div className="h-4 bg-muted rounded w-24 animate-pulse" aria-hidden="true"></div>
                <div className="h-10 bg-muted rounded animate-pulse" aria-hidden="true"></div>
              </div>
            ))}
          </div>
          <div className="space-y-2">
            <div className="h-4 bg-muted rounded w-32 animate-pulse" aria-hidden="true"></div>
            <div className="h-24 bg-muted rounded animate-pulse" aria-hidden="true"></div>
          </div>
          <footer className="flex justify-end space-x-3">
            <div className="h-10 w-20 bg-muted rounded animate-pulse" aria-hidden="true"></div>
            <div className="h-10 w-20 bg-muted rounded animate-pulse" aria-hidden="true"></div>
          </footer>
        </fieldset>
      </form>
  ...
  <main className="min-h-screen bg-background" role="status" aria-label="Φόρτωση λίστας">
    <header className="border-b bg-card p-6">
      <div className="flex items-center justify-between">
        <div className="h-8 bg-muted rounded w-32 animate-pulse" aria-hidden="true"></div>
        <div className="h-10 w-32 bg-muted rounded animate-pulse" aria-hidden="true"></div>
      </div>
    </header>
    <section className="p-6">
        ...
        {Array.from({ length: 8 }).map((_, i) => (
          <li key={i}>
            <article className="bg-card border rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div className="space-y-2">
                  <div className="h-5 bg-muted rounded w-32 animate-pulse" aria-hidden="true"></div>
                  <div className="h-4 bg-muted rounded w-48 animate-pulse" aria-hidden="true"></div>
                </div>
                <div className="h-6 w-16 bg-muted rounded-full animate-pulse" aria-hidden="true"></div>
              </div>
            </article>
          </li>
        ))}
