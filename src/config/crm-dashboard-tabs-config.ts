...
export const CRM_DASHBOARD_TABS: CRMDashboardTabConfig[] = [
  ...
  {
    id: 'pipeline',
    label: 'tabs.pipeline.label',
    value: 'pipeline',
    icon: 'target',
    description: 'tabs.pipeline.description',
    order: 2,
    enabled: true,
  ...
  {
    id: 'communications',
    label: 'tabs.communications.label',
    value: 'communications',
    icon: 'message-circle',
    description: 'tabs.communications.description',
    order: 3,
    enabled: true,
  ...
  {
    id: 'tasks',
    label: 'tabs.tasks.label',
    value: 'tasks',
    icon: '⏰',
    description: 'tabs.tasks.description',
    order: 4,
    enabled: true,
    component: 'TasksTab',
  },
  {
    id: 'calendar',
    label: 'tabs.calendar.label',
    value: 'calendar',
    icon: 'calendar',
    description: 'tabs.calendar.description',
    order: 5,
    enabled: true,
