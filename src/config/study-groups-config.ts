...
export const STUDY_GROUPS: readonly StudyGroupMeta[] = [
  {
    ...
    bgClass: 'bg-[hsl(var(--bg-info))]/20',
    iconBgClass: 'bg-[hsl(var(--bg-info))]/20',
    order: 1,
  },
  {
    group: 'fiscal',
    ...
    icon: 'Landmark',
    colorClass: 'text-[hsl(var(--text-success))]',
    borderClass: 'border-l-[hsl(var(--text-success))]',
    bgClass: 'bg-[hsl(var(--bg-success))]/10',
    iconBgClass: 'bg-[hsl(var(--bg-success))]/10',
    order: 2,
  },
  {
    group: 'architectural',
  ...
  },
  {
    ...
    borderClass: 'border-l-[hsl(var(--text-warning))]',
    bgClass: 'bg-[hsl(var(--bg-warning))]/40',
    iconBgClass: 'bg-[hsl(var(--bg-warning))]/40',
    order: 4,
  },
  {
    group: 'mechanical',
