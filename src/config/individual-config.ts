...
export const INDIVIDUAL_SECTIONS: IndividualSectionConfig[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    icon: 'camera',
    description: 'Upload φωτογραφίας για το προφίλ του ατόμου',
    order: 5,
    fields: [
      {
        id: 'description',
        type: 'textarea',
        label: 'Σημειώσεις Φωτογραφίας',
        placeholder: 'Προαιρετικές σημειώσεις για τη φωτογραφία...',
        helpText: 'Προαιρετικές πληροφορίες για τη φωτογραφία προφίλ',
        icon: 'camera',
      }
    ],
  },
