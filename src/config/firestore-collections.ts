...
export const COLLECTIONS = {
  ...
  /**
   * ADR-882 Φάση 2 — **ΤΟ ΙΣΤΟΡΙΚΟ ΑΝΑΖΗΤΗΣΕΩΝ ΤΟΠΟΥ ΤΟΥ ΛΟΓΑΡΙΑΣΜΟΥ** (`uplsrch_{uid}`): ΕΝΑ
   * έγγραφο ανά άνθρωπο, ώστε το ιστορικό να τον ακολουθεί σε κάθε συσκευή.
   *
   * 🔑 Σύνολο «κερδίζει ο νεότερος» **ανά εγγραφή**, όχι ανά λίστα: κάθε γραφή αγγίζει μόνο
   * το δικό της πεδίο ⇒ δύο συσκευές δεν σβήνουν η μία τη δουλειά της άλλης.
   * ✅ Γράφει/διαβάζει **μόνο ο ιδιοκτήτης** — καμία ερώτηση πέρα από «είσαι εσύ;».
   */
  USER_PLACE_SEARCHES: process.env.NEXT_PUBLIC_USER_PLACE_SEARCHES_COLLECTION || 'user_place_searches',
  /**
