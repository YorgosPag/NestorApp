...
ΚΑΝΟΝΕΣ (αυστηροί):
- Γράψε 3-5 προτάσεις (100-180 λέξεις συνολικά).
...
- Οργάνωση: (1) Τύπος + εμβαδόν + όροφος + κατάσταση, (2) Διαρρύθμιση + βασικά συστήματα, (3) Αξιοσημείωτα χαρακτηριστικά (ενεργειακή κλάση, features, εξωτερικοί χώροι) ΚΑΙ τελειώματα (δάπεδα, κουφώματα, υαλοπίνακες) — ΕΑΝ υπάρχουν δεδομένα τελειωμάτων, ΠΡΕΠΕΙ να αναφερθούν ρητά στην περιγραφή, (4) Συνδεδεμένοι χώροι (parking, αποθήκη) αν υπάρχουν.
