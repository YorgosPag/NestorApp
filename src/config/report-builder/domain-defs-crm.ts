...
export const CRM_TASKS_DEFINITION: DomainDefinition = {
  ...
  fields: [
    ...
    { key: 'propertyId', labelKey: 'domains.crmTasks.fields.unit', type: 'text', filterable: true, sortable: false, defaultVisible: false, refDomain: 'properties', refDisplayField: 'name' },
