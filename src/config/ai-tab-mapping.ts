...
- Ζητήθηκε "καρτέλα X" → ΜΟΝΟ τα πεδία αυτής της καρτέλας
- ΔΕΝ ζητήθηκε καρτέλα → δείξε τα πιο σημαντικά (όνομα, τηλ, email, ΑΦΜ)
- ΠΟΤΕ μην αναμειγνύεις πεδία διαφορετικών καρτελών αν ζητήθηκε συγκεκριμένη`;
