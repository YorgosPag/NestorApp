...
export const COMPANY_GEMI_SECTIONS: SectionConfig[] = [
  ...
  // -------------------------------------------------------------------------
  // 8. ΛΟΓΟΤΥΠΟ ΕΤΑΙΡΕΙΑΣ
  // -------------------------------------------------------------------------
  {
    id: 'logo',
    title: 'Λογότυπο Εταιρείας',
    icon: 'building',
    description: 'Upload λογότυπου και εταιρικής ταυτότητας',
    order: 8,
    fields: [
      {
        id: 'description',
        type: 'textarea',
        label: 'Σημειώσεις Λογότυπου',
        placeholder: 'Προαιρετικές σημειώσεις για το λογότυπο της εταιρείας...',
        helpText: 'Προαιρετικές πληροφορίες για την εταιρική ταυτότητα',
        icon: 'building',
      }
    ],
  },
