...
export const CATEGORY_CAPTURE_CAPABILITIES: Record<FileCategory, CaptureSource[]> = {
  ...
  models: ['upload'],
  // ADR-884 Φ0.8 — 🔑 **μόνο `upload`**: η σφαίρα 360° βγαίνει από κάμερα 360° ή από συρραφή (Φ2.Κ)· η κάμερα
  //   του browser δίνει **επίπεδη** φωτογραφία, που η επικύρωση (2:1) θα απέρριπτε. Υπόσχεση που δεν τηρείται = όχι.
  panoramas: ['upload'],
} as const;
