...
export const FIRST_CONTACT_REJECTIONS = [
  ...
  'target-absent',
  /**
   * 🔴 **Ο επαγγελματίας ΥΠΑΡΧΕΙ — και το ΓΕΜΗ λέει ότι δεν είναι ενεργός** (ADR-841 §7 Α23 Φ3.2).
   *
   * ⚠️ Ξεχωριστό από το `target-absent` για τον λόγο του `target-not-live`: η βιτρίνα **φαίνεται**, με
   * την ετικέτα της — ένα «δεν το βρήκαμε» θα έλεγε ψέματα. Κριτής: `registryClosureOf`.
   */
  'target-closed',
  /**
