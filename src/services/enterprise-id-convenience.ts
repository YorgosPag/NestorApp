...
// ADR-881 §4.2 — ΕΚΔΟΣΗ ΕΙΚΟΝΑΣ ΗΡΩΑ. Μαζί με τη μέθοδο (το μάθημα του `mreq`).
export const generateLandingHeroRevisionId = () =>
  enterpriseIdService.generateLandingHeroRevisionId();
