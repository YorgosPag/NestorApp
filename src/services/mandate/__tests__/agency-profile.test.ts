...
function declaration(
  ...
  return {
    ...
    place: null,
    position: null,
    // ⛔ **ΚΑΝΕΝΑ `mark` ΕΔΩ ΠΙΑ** (ADR-841 §7 Α21.8): έγινε **δική του πράξη**, γιατί η
    //    οθόνη **δεν είχε από πού** να ξαναστείλει το ιδιωτικό μονοπάτι — διαβάζει πίσω
    //    δημόσιο URL. Όσο ζούσε εδώ, κάθε δεύτερη δημοσίευση **έσβηνε το λογότυπο**.
    //    Την επιβίωση την κρίνει το `showcase-mark-survival.test.ts`.
    ...overrides,
  };
}
