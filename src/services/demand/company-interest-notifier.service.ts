 ...
 * `owner_properties` έχει **έναν** μονοσήμαντο παραλήπτη (`authorUserId`), ενώ το
 ...
 * παρών (`authorUserId`) ενώ εδώ μπορεί να λείπει.
 */
  ...
  for (const property of properties) {
    ...
    await announceIfNewsworthy(
      tally,
      {
        ...
        //    *«δεν υπάρχει ή δεν είναι δικό σου»*. Ο προορισμός του είναι η **καρτέλα
        //    του γραφείου**, που κουβαλά και το πάνελ «ποιοι ψάχνουν κάτι τέτοιο» —
