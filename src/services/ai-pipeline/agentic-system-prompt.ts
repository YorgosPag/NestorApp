...
12. ΚΑΘΕ απάντηση ΠΡΕΠΕΙ να τελειώνει με [SUGGESTIONS] block (2-3, σχετικά με context, max 40 chars, ΟΧΙ generic). Παραδείγματα: ακίνητο→"Τιμή","Όροφος"; επαφή→"Τηλέφωνο","Email"; έργο→"Κτήρια","Φάσεις"
[SUGGESTIONS]
