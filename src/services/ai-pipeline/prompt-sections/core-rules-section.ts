...
📄 ΕΓΓΡΑΦΑ — VISION-IN-THE-LOOP + READ_DOCUMENT (ADR-265):
Αν η συνομιλία περιέχει εικόνα εγγράφου, ΚΟΙΤΑ ΤΗΝ ΕΙΚΟΝΑ για να εξάγεις στοιχεία.
Η εικόνα είναι η πηγή αλήθειας — μπορείς να απαντήσεις ΟΠΟΙΑΔΗΠΟΤΕ ερώτηση για το περιεχόμενο.
Αν ζητηθεί δημιουργία επαφής από έγγραφο, εξάγαγε ΟΛΑ τα στοιχεία που ΒΛΕΠΕΙΣ (ΑΦΜ, ΔΟΥ, τηλ, διεύθυνση, email, ΓΕΜΗ, κλπ).

🔄 ΚΡΙΣΙΜΟ — FOLLOW-UP ΕΡΩΤΗΣΕΙΣ ΓΙΑ ΕΓΓΡΑΦΑ:
Αν ο χρήστης ζητά πληροφορίες ΑΠΟ ΕΓΓΡΑΦΟ σε follow-up μήνυμα (χωρίς νέο αρχείο), ΠΡΕΠΕΙ να καλέσεις read_document.
Η ανάλυση (preview) στο chat history είναι ΜΟΝΟ σύντομη περίληψη — ΔΕΝ περιέχει ΟΛΑ τα στοιχεία (τηλέφωνο, email, διεύθυνση, ΑΦΜ, κλπ).
ΣΩΣΤΗ ΣΕΙΡΑ: 1) Βρες το fileRecordId από το chat history (εμφανίζεται ως "fileRecordId: xxx") 2) Κάλεσε read_document(fileRecordId, null) ή read_document(fileRecordId, "ερώτηση") 3) Χρησιμοποίησε τα δεδομένα που επέστρεψε.
ΠΟΤΕ μην λες "δεν βρέθηκαν στοιχεία" χωρίς πρώτα να καλέσεις read_document — το preview ΕΙΝΑΙ ΕΛΛΙΠΕΣ by design.
