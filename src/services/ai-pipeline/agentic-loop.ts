...
- taxOffice: ΜΟΝΟ 4-ψήφιος κωδικός ΔΟΥ (ΟΧΙ όνομα!). Πλήρης πίνακας DOY_CODE_MAP παρακάτω

DOY_CODE_MAP (taxOffice — αποθηκεύεται ο ΚΩΔΙΚΟΣ, ΟΧΙ το όνομα):
ΑΤΤΙΚΗ: 1101=Α' Αθηνών, 1104=Δ' Αθηνών, 1106=ΣΤ' Αθηνών, 1110=Ι' Αθηνών, 1113=ΙΓ' Αθηνών, 1114=ΙΔ' Αθηνών, 1116=ΙΣΤ' Αθηνών, 1119=Κατοίκων Εξωτερικού, 1120=ΦΑΕ Αθηνών, 1121=Α' Αμαρουσίου, 1124=Αγ. Αναργύρων, 1125=Αγ. Δημητρίου, 1127=Αιγάλεω, 1129=Αχαρνών, 1130=Βύρωνα, 1131=Γλυφάδας, 1133=Ελευσίνας, 1135=Ηλιουπόλεως, 1137=Καλλιθέας, 1138=Κηφισιάς, 1139=Κορωπίου, 1140=Ν. Ιωνίας, 1141=Ν. Σμύρνης, 1143=Παλλήνης, 1146=Περιστερίου, 1149=Χαλανδρίου, 1150=Χολαργού, 1151=Ψυχικού
ΠΕΙΡΑΙΑΣ: 1201=Α' Πειραιά, 1205=Ε' Πειραιά, 1209=ΦΑΕ Πειραιά, 1210=Αίγινας, 1211=Νίκαιας, 1212=Π. Φαλήρου, 1213=Σαλαμίνας
ΘΕΣΣΑΛΟΝΙΚΗ: 1301=Α' Θεσ/νίκης, 1304=Δ' Θεσ/νίκης, 1305=Ε' Θεσ/νίκης, 1308=Η' Θεσ/νίκης, 1310=ΦΑΕ Θεσ/νίκης, 1311=Αμπελοκήπων, 1312=Καλαμαριάς, 1313=Λαγκαδά, 1314=Νεαπόλεως, 1315=Τούμπας, 1317=Ιωνίας Θεσ/νίκης, 1316=Ωραιοκάστρου
Κ. ΜΑΚΕΔΟΝΙΑ: 1401=Βέροιας, 1402=Έδεσσας, 1403=Κατερίνης, 1404=Κιλκίς, 1406=Πολυγύρου, 1407=Σερρών
ΑΝ. ΜΑΚΕΔΟΝΙΑ-ΘΡΑΚΗ: 1501=Αλεξανδρούπολης, 1502=Δράμας, 1503=Καβάλας, 1504=Κομοτηνής, 1505=Ξάνθης, 1506=Ορεστιάδας
Δ. ΜΑΚΕΔΟΝΙΑ: 1601=Γρεβενών, 1602=Καστοριάς, 1603=Κοζάνης, 1604=Πτολεμαΐδας, 1605=Φλώρινας
ΗΠΕΙΡΟΣ: 1701=Άρτας, 1702=Ηγουμενίτσας, 1703=Ιωαννίνων, 1704=Πρεβέζης
ΘΕΣΣΑΛΙΑ: 1801=Βόλου, 1802=Καρδίτσας, 1803=Α' Λάρισας, 1805=Τρικάλων
ΣΤ. ΕΛΛΑΔΑ: 1901=Λαμίας, 1902=Λιβαδειάς, 1903=Χαλκίδας
Δ. ΕΛΛΑΔΑ: 2001=Α' Πατρών, 2003=Αγρινίου, 2004=Αμαλιάδας, 2005=Μεσολογγίου, 2006=Πύργου
ΠΕΛΟΠΟΝΝΗΣΟΣ: 2101=Κορίνθου, 2102=Ναυπλίου, 2103=Σπάρτης, 2104=Τρίπολης, 2105=Καλαμάτας
ΙΟΝΙΑ ΝΗΣΙΑ: 2201=Κέρκυρας, 2202=Ζακύνθου, 2203=Λευκάδας, 2204=Αργοστολίου
Β. ΑΙΓΑΙΟ: 2301=Μυτιλήνης, 2302=Σάμου, 2303=Χίου
Ν. ΑΙΓΑΙΟ: 2401=Ρόδου, 2402=Κω, 2403=Σύρου, 2404=Νάξου, 2405=Μυκόνου, 2406=Θήρας
ΚΡΗΤΗ: 2501=Ηρακλείου, 2502=Χανίων, 2503=Ρεθύμνου, 2504=Αγ. Νικολάου
ΕΙΔΙΚΕΣ: 9101=Μεγάλων Επιχειρήσεων, 9102=Πλοίων, 9103=ΚΕΦΟΔΕ
Αν ο χρήστης πει "Ιωνία Θεσσαλονίκης" → γράψε "1317". Αν πει "Καλλιθέα" → γράψε "1137". ΠΑΝΤΑ κωδικός, ΠΟΤΕ όνομα.
