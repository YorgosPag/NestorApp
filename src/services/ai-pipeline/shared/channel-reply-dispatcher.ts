 ...
 * =============================================================================
 *
 * Centralized dispatcher that routes outbound text replies to the appropriate
 * channel (Email via Mailgun, Telegram, WhatsApp, Messenger, Instagram, In-App).
 *
 ...
 * - channel-reply-types.ts     — Types + extractChannelIds()
 * - channel-reply-dispatcher.ts — Text reply routing (this file)
 * - channel-media-dispatcher.ts — Media file routing (SPEC-257F)
 *
...
export { extractChannelIds } from './channel-reply-types';
export { sendChannelMediaReply } from './channel-media-dispatcher';

const logger = createModuleLogger('CHANNEL_REPLY_DISPATCHER');

// ============================================================================
// TEXT REPLY DISPATCHER
// ============================================================================
 ...
 * - `whatsapp` → sendWhatsAppMessage() (dynamic import)
 * - `messenger` → sendMessengerMessage() (dynamic import)
 * - `instagram` → sendInstagramMessage() (dynamic import)
 * - `in_app` → Firestore voice_commands update
 *
...
// ============================================================================
// CHANNEL-SPECIFIC TEXT DISPATCHERS
// ============================================================================
