 ...
 *
 * ⛔ **ΠΟΤΕ επεξεργασία γραμμής που έχει ΔΗΜΟΣΙΕΥΤΕΙ.** Διόρθωση = νέα γραμμή με σημερινή
 * ημερομηνία· η παλιά είναι ό,τι είδε το κοινό. ⚠️ Όσο **καμία** σελίδα δεν δείχνει τον φορέα
 * (πριν τη Φ2 και πριν το δημόσιο άνοιγμα), η γραμμή διορθώνεται επί τόπου — δεν δημοσιεύτηκε.
...
export const PLATFORM_OPERATORS: readonly OperatorRecord[] = [
  {
    ...
    // Πόλη: διορθώθηκε επί τόπου 2026-09-16 («Θεσσαλονίκη» → «Ελευθέριο-Κορδελιό», ο δήμος του Τ.Κ.),
    // με απόφαση του φορέα, ΠΡΙΝ δημοσιευτεί πουθενά.
    seat: { street: 'Σαμοθράκης', number: '16', postalCode: '56334', city: 'Ελευθέριο-Κορδελιό', country: 'GR' },
    vatNumber: '040817944',
    gemiNumber: null,
    // 🔴 ΜΕΤΡΗΜΕΝΟ 2026-09-15 23:55: δοκιμαστικό του φορέα προς `info@` ΕΠΕΣΤΡΕΨΕ —
    // «550 5.0.1 Recipient rejected». Η διεύθυνση ΔΕΝ υπάρχει.
    // ⇒ Απόφαση φορέα 2026-09-16 (ADR-861 Φ2): **προσωρινά το Gmail που διαβάζει ο ίδιος**, διορθωμένο
    // επί τόπου γιατί καμία σελίδα δεν είχε ακόμη δείξει τη γραμμή. Όταν στηθεί η προώθηση Mailgun
    // (`info@`/`privacy@`) και περάσει δοκιμαστικό ⇒ **ΝΕΑ γραμμή** με εκείνη τη μέρα· αυτή μένει.
    contact: { address: 'georgios.pagonis@gmail.com', receivingConfirmedOn: '2026-09-16' },
    privacy: { address: 'georgios.pagonis@gmail.com', receivingConfirmedOn: '2026-09-16' },
  },
];
