...
function buildProjectKPIs(
  ...
  return [
    ...
    { title: t('projects.kpis.totalProperties'), value: data.totalProperties, icon: Building2, color: 'purple' as const },
    { title: t('projects.kpis.soldProperties'), value: sold, icon: ShoppingCart, color: 'orange' as const },
