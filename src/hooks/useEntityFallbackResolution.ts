 ...
 *
 * ⚠️ **ΓΙΑ ΤΗΝ ΠΗΓΗ**: δώσε διαδρομή που **ελέγχει εταιρεία**. Το παλιό
 * `getStorageUnitById` (`services/storage.service.ts`, **διαγράφηκε** 2026-09-19,
 * ADR-777 §8.60.20) ήταν server action με Admin SDK **χωρίς κανέναν έλεγχο
 * `companyId`** — διαρροή μεταξύ εταιρειών (CHECK 3.35). Φρουρός: άγκυρα `Α7`.
 *
