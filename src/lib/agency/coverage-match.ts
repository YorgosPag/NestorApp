...
import {
  footprintRelation,
  outlineOverFootprint,
  type CoverageRelation,
} from '@/lib/geo/geo-shape-relation';
import {
 ...
 */
// 🔑 **ΕΝΑΣ ΟΡΙΣΜΟΣ, ΔΥΟ ΠΟΡΤΕΣ** — ο τύπος και οι δύο καθαρά γεωμετρικές σχέσεις
//    μετακόμισαν στο `lib/geo/geo-shape-relation` *(N.7.1: το αρχείο έφτασε 510)*.
//    Ξανα-εξάγονται εδώ ώστε **κανένας** υπάρχων καταναλωτής να μη χρειαστεί αλλαγή.
export type { CoverageRelation };
export { footprintRelation, outlineOverFootprint };
