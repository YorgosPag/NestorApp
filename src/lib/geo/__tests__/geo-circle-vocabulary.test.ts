...
const PENDING_MIGRATION: ReadonlyMap<string, string> = new Map([
  [
    'lib/agency/showcase-filter.ts',
    'ανήκει σε άλλη ροή εργασίας· μεταναστεύει με δικό της ρυθμό (LSC, μη ατομικά). Όταν φύγει, το Κ4 απαιτεί τη διαγραφή του ψευδωνύμου.',
  ],
]);
