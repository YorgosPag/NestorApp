...
describe('Λ — το σύνορο δεν αγγίζει ταυτότητα', () => {
  ...
  it('Λ3: ο ΠΑΡΟΝΟΜΑΣΤΗΣ — το δίχτυ ΟΝΤΩΣ κρίνει ταυτότητα στον διακομιστή', () => {
    ...
    //
    // 🔴 ADR-819 — Ο ΜΗΧΑΝΙΣΜΟΣ ΜΕΤΑΚΙΝΗΘΗΚΕ ΞΑΝΑ· Η ΠΡΟΘΕΣΗ ΕΜΕΙΝΕ ΑΚΕΡΑΙΗ.
    //    Ήταν `expect(net).toContain('PERSONAL_WORKSPACE_ALIAS')`. Το δίχτυ δεν
    //    **κατασκευάζει** πια το τμήμα διεύθυνσης — το **ζητά** από τη μία
