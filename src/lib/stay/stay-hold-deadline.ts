 ...
 *
 * 🔴 **Ρολόι 24 ωρών (`h23`)** — ADR-777 §8.60.21.7, μετρημένο ζωντανά 2026-09-22: το ελληνικό 12ωρο
 * τελειώνει σε «π.μ.»/«μ.μ.», και κάθε πρότυπο που κλείνει πρόταση μετά το `{until}` έγραφε
 * «10:17 π.μ..». Ίδιο ρολόι με τις ώρες απόκρισης (`weekly-hours`)· `h23`, όχι `hour12: false`,
 * που σε ορισμένες εκδόσεις ICU γράφει τα μεσάνυχτα «24:00».
 */
