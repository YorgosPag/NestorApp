...
describe('Κ6 — τα δηλωμένα κενά', () => {
  it('η νομιμότητα (Α17) είναι ΜΕΣΑ, και πρώτη', () => {
    // Αν κάποτε υλοποιηθεί η Α17, αυτή η άγκυρα είναι το σημείο που θα το θυμίσει:
    // η γραμμή φεύγει από εδώ ΚΑΙ από την οθόνη, μαζί.
    expect(LISTING_OPEN_SUBJECTS[0]).toBe('legality');
  });
