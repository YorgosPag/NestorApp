...
export const PERMISSIONS = {
  ...
  // ADR-867 Ε1β — «απαντά για λογαριασμό του γραφείου»: μπαίνει σε ομάδα πράξης (υπεύθυνος ή
  // συνεργάτης) και άρα γράφει στον αντισυμβαλλόμενο. Πρότυπο Zendesk light agent / Slack guest:
  // ο επισκέπτης **υπάρχει** στο γραφείο (θέση), αλλά δεν αναλαμβάνει ποτέ και δεν απαντά ποτέ.
  "network:threads:respond": true,
