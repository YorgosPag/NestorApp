...
| **Entity audit coverage — write side** (CHECK 3.17) | ADR-195 | `.entity-audit-coverage-baseline.json` | **19 violations** (base 20, −1) | 19 αρχεία | Boy Scout |
...
| B.2 | `accounting_audit_log`, `accounting_invoices`, `accounting_journal_entries` | `immutable` + `role_dual` (new pattern) | ⏳ pending |
