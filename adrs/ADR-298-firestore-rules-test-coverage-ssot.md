...
| P0 | B.2 | `accounting_audit_log`, `accounting_invoices`, `accounting_journal_entries` | `immutable` + `role_dual` | ΚΦΔ Q7 compliance — immutability legal requirement | ⏳ pending |
