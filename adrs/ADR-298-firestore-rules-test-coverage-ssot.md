...
| P1 | B.4 | `properties`, `storage_units`, `parking_spots`, `floors` | `admin_write_only` (όχι `field_allowlist` — write rules είναι `if false`, structural hierarchy mutated server-side only) | Property structural invariants | ⏳ pending |
