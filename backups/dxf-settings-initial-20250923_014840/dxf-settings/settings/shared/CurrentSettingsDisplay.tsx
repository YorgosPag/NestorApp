...
export function CurrentSettingsDisplay({
  ...
  useEffect(() => {
    console.log('🔄 [CurrentSettingsDisplay] Settings updated:', {
      activeTab,
      effectiveTextSettings: effectiveTextSettings ? { color: effectiveTextSettings.color, fontSize: effectiveTextSettings.fontSize, fontFamily: effectiveTextSettings.fontFamily } : null,
      forceUpdate
    });
