...
import type { Point2D, AnySceneEntity, LineEntity, RectangleEntity, SceneModel } from '../../types/scene';
import { generateEdgeMidpoints, calculateMidpoint } from '../../utils/renderers/shared/geometry-rendering-utils';
