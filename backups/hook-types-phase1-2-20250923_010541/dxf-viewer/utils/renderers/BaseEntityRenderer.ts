...
import { coordTransforms, type ViewTransform, type Point2D } from '../../systems/rulers-grid/config';
import { CAD_UI_COLORS } from '../../config/color-config';
import type { GripSettings } from '../../types/gripSettings';
import { PhaseManager } from '../../systems/phase-manager/PhaseManager';
import type { EntityModel, RenderOptions, GripInfo, PhaseManagerOptions } from '../../types/renderer';
...
export abstract class BaseEntityRenderer {
  ...
  private drawInternalArc(
    vertex: Point2D,
    prevUnit: {x: number; y: number},
    nextUnit: {x: number; y: number}, 
    rPx: number
  ): void {
