...
export class AngleMeasurementRenderer extends BaseEntityRenderer {
  ...
  hitTest(entity: EntityModel, screenPoint: Point2D, tolerance: number = 8): boolean {
    ...
    // Check if point is near any of the lines
    return pointToLineDistance(screenPoint, screenVertex, screenPoint1) <= tolerance ||
           pointToLineDistance(screenPoint, screenVertex, screenPoint2) <= tolerance;
  }
