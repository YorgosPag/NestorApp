import type { Region, Point2D, RegionStatus, OverlayLayer } from '../types/overlay';
import { STATUS_COLORS, calculateRegionArea, calculateRegionPerimeter } from '../types/overlay';
