...
export const UI_COLORS = {
  ...
  MEASUREMENT_POINTS: '#00FF80',
  DISTANCE_TEXT: '#00ff00',
  
  // Grip colors
  GRIP_DEFAULT: '#00ff80',
  GRIP_HOVER: '#00FF80',
  GRIP_SELECTED: '#00FF80',
  GRIP_OUTLINE: '#000000',
  
  // Snap indicator colors
  SNAP_MIDPOINT: '#00FF80',
...
export const SIMPLE_COLORS = [
  ...
  '#ffffff', '#00FF80', '#00FF80', '#444444', '#000000',
  ...
  '#c8e6c9', '#00FF80', '#4caf50', '#388e3c', '#2e7d32',
...
export const LEGACY_COLORS = {
  ...
  YELLOW: '#00FF80', // CHANGED από κίτρινο σε πράσινο
