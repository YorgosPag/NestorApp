...
export class LayerOperationsService {
  ...
  public mergeLayers(
    ...
    console.log('🔄 [LayerOperationsService] Merging layers:', {
    ...
    console.log('✅ Layers merge completed! Merged', sourceLayerNames.length, 'layers into', targetLayerName);
  ...
  public mergeColorGroups(
    ...
    console.log('🔄 [LayerOperationsService] Hierarchical color groups merge:', {
      target: targetColorGroup,
      sources: sourceColorGroups
    });
    ...
    console.log('✅ Hierarchical Color Groups merge completed! Moved layers from', sourceColorGroups.length, 'groups');
  ...
  public deleteColorGroup(
    ...
    console.log(`🗑️ Deleting Color Group: ${colorGroupName} with ${layersInGroup.length} layers`);
  ...
  public changeColorGroupColor(
    ...
    console.log(`🎨 Changing Color Group ${colorGroupName} to ${color}`);
