...
export function useToolbarState() {
  ...
  const handleToolChange = useCallback((
    ...
    if (DEBUG_TOOLBAR_STATE) console.log('📋 [useToolbarState] handleToolChange called with:', tool);
    ...
    if (tool === 'measure-distance') {
      ...
      console.log('📏 [useToolbarState] Starting measure-distance as drawing tool');
      onDrawingStart('measure-distance');
    } else if (tool === 'measure-area') {
      console.log('📏 [useToolbarState] Starting measure-area as drawing tool');
      ...
      console.log('📏 [useToolbarState] Starting measure-angle as drawing tool');
