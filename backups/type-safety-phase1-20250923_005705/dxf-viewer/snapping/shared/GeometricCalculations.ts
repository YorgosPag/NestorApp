...
import { calculateDistance, rotatePoint } from '../../utils/renderers/shared/geometry-rendering-utils';
...
export class GeometricCalculations {
  ...
  static getRectangleCorners(rectangle: any): Point2D[] {
  ...
  static getRectangleLines(rectangle: any): RectangleLine[] {
  ...
  static isEntityNearPoint(entity: Entity, point: Point2D, radius: number): boolean {
    ...
    if (entityType === 'line') {
      ...
      if (entity.center && entity.radius) {
        const distanceToCenter = GeometricCalculations.calculateDistance(point, entity.center);
