...
export interface ToolbarsContextType {
  ...
  moveToolbar: (toolbarId: string, position: any) => void;
  ...
  // Event Management
  addEventListener: (event: keyof ToolEvents, callback: any) => void;
  removeEventListener: (event: keyof ToolEvents, callback: any) => void;
